...
const seoConfig = await useToolSEOAsync({
  name: 'Wan 2.7 R2V Generator',
  description: 'Generate videos from mixed references with Wan 2.7 r2v model.',
  category: 'video',
  route: '/home/wan/v2-7-r2v',
  keywords: ['Wan 2.7', 'R2V', 'AI video'],
  applicationCategory: 'MultimediaApplication',
  applicationSubCategory: 'Video Generation',
  offers: { price: '0', priceCurrency: 'USD' },
  offerDescription: 'Pay per video with credits.',
  priceFromApi: { modelKey: 'wan-2-7-r2v', eligibleQuantityName: 'Credits Required' }
})
useHead(seoConfig)
</script>
