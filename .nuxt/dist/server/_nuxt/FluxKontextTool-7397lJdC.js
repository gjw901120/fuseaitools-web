...
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrIncludeBooleanAttr, ssrLooseContain, ssrRenderComponent, ssrLooseEqual } from "vue/server-renderer";
  ...
  setup(__props) {
    ...
    const fluxKontextPriceText = computed(() => {
      if (activeTab.value !== "generate") {
        ...
        if (!str2) return "";
        return `· ${str2} credits${discountText.value}`;
      }
...
//# sourceMappingURL=FluxKontextTool-7397lJdC.js.map
