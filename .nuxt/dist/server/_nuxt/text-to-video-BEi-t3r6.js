    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-aa33b255${_scopeId}>`);
...
const textToVideo = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-aa33b255"]]);
export {
  textToVideo as default
};
//# sourceMappingURL=text-to-video-BEi-t3r6.js.map
