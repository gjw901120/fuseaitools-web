    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-6d5b90f6${_scopeId}>`);
...
const speechToText = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6d5b90f6"]]);
export {
  speechToText as default
};
//# sourceMappingURL=speech-to-text-ByyP6DR1.js.map
