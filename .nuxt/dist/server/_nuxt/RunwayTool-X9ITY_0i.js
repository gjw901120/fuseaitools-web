...
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrIncludeBooleanAttr, ssrRenderComponent, ssrLooseContain, ssrLooseEqual, ssrRenderStyle } from "vue/server-renderer";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div></div>`);
      if (activeTab.value === "generate") {
        _push(`<div class="usage-tips" data-v-d2252e65><div class="tip-item" data-v-d2252e65><span class="tip-icon" data-v-d2252e65>📝</span><span data-v-d2252e65><strong data-v-d2252e65>Detailed Description:</strong> Include details like scenes, actions, camera movement, lighting, etc.</span></div><div class="tip-item" data-v-d2252e65><span class="tip-icon" data-v-d2252e65>🎬</span><span data-v-d2252e65><strong data-v-d2252e65>Cinematic Terms:</strong> Use professional terms like &quot;close-up&quot;, &quot;wide shot&quot;, &quot;tracking shot&quot;</span></div><div class="tip-item" data-v-d2252e65><span class="tip-icon" data-v-d2252e65>🎨</span><span data-v-d2252e65><strong data-v-d2252e65>Style Specification:</strong> Such as &quot;sci-fi style&quot;, &quot;romantic comedy&quot;, &quot;action film&quot;</span></div><div class="tip-item" data-v-d2252e65><span class="tip-icon" data-v-d2252e65>⏱️</span><span data-v-d2252e65><strong data-v-d2252e65>Duration Limit:</strong> 10-second videos do not support 1080p resolution</span></div><div class="tip-item" data-v-d2252e65><span class="tip-icon" data-v-d2252e65>🖼️</span><span data-v-d2252e65><strong data-v-d2252e65>Reference Image:</strong> Providing an image URL can add animation effects to existing images</span></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (activeTab.value === "aleph") {
        _push(`<div class="usage-tips" data-v-d2252e65><div class="tip-item" data-v-d2252e65><span class="tip-icon" data-v-d2252e65>🔄</span><span data-v-d2252e65><strong data-v-d2252e65>Transformation Description:</strong> Focus on describing the style changes and effect transformations you want</span></div><div class="tip-item" data-v-d2252e65><span class="tip-icon" data-v-d2252e65>📹</span><span data-v-d2252e65><strong data-v-d2252e65>Motion Effects:</strong> Use camera movement terminology to enhance video dynamics</span></div><div class="tip-item" data-v-d2252e65><span class="tip-icon" data-v-d2252e65>⏰</span><span data-v-d2252e65><strong data-v-d2252e65>Temporal Control:</strong> Control transformation rhythm through temporal elements (gradually, suddenly, etc.)</span></div><div class="tip-item" data-v-d2252e65><span class="tip-icon" data-v-d2252e65>🎥</span><span data-v-d2252e65><strong data-v-d2252e65>Video Requirements:</strong> Ensure video URL is accessible via HTTPS and file size does not exceed 10MB</span></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (activeTab.value === "extend") {
        _push(`<div class="usage-tips" data-v-d2252e65><div class="tip-item" data-v-d2252e65><span class="tip-icon" data-v-d2252e65>➡️</span><span data-v-d2252e65><strong data-v-d2252e65>Continuation Description:</strong> Describe what should happen next in the video sequence</span></div><div class="tip-item" data-v-d2252e65><span class="tip-icon" data-v-d2252e65>🔗</span><span data-v-d2252e65><strong data-v-d2252e65>Consistency:</strong> Maintain visual and narrative consistency with the original video</span></div><div class="tip-item" data-v-d2252e65><span class="tip-icon" data-v-d2252e65>⚡</span><span data-v-d2252e65><strong data-v-d2252e65>Dynamic Actions:</strong> Specify movements, actions, and developments clearly</span></div><div class="tip-item" data-v-d2252e65><span class="tip-icon" data-v-d2252e65>🎯</span><span data-v-d2252e65><strong data-v-d2252e65>Quality Selection:</strong> Choose resolution based on your needs - 720p for faster generation, 1080p for higher quality</span></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
//# sourceMappingURL=RunwayTool-X9ITY_0i.js.map
