...
const _sfc_main = {
  ...
  setup(__props) {
    const seoConfig = useToolSEO({
      ...
      description: "Veo3 Text to Video - Generate high-quality AI video from text. Use Google Veo 3 for free online.",
      category: "video",
      route: "/home/veo3/text-to-video",
      keywords: ["Veo3", "Text to Video", "AI video", "Google Veo"],
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-f030164c${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/veo3/text-to-video.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const textToVideo = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f030164c"]]);
export {
  textToVideo as default
};
//# sourceMappingURL=text-to-video-BaX3ioFw.js.map
