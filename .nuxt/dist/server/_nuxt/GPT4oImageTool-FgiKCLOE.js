...
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderClass, ssrInterpolate, ssrIncludeBooleanAttr, ssrRenderComponent, ssrLooseContain, ssrRenderList } from "vue/server-renderer";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div></div><div class="usage-tips" data-v-adcce118><div class="tip-item" data-v-adcce118><span class="tip-icon" data-v-adcce118>✨</span><span data-v-adcce118>Provide detailed descriptive prompts for better results</span></div><div class="tip-item" data-v-adcce118><span class="tip-icon" data-v-adcce118>🖼️</span><span data-v-adcce118>Upload reference images to guide generation direction</span></div><div class="tip-item" data-v-adcce118><span class="tip-icon" data-v-adcce118>📐</span><span data-v-adcce118>Support multiple aspect ratios, choose the appropriate ratio</span></div><div class="tip-item" data-v-adcce118><span class="tip-icon" data-v-adcce118>🔄</span><span data-v-adcce118>Enable the fallback mechanism to improve generation success rate</span></div></div></div>`);
    };
  }
};
...
//# sourceMappingURL=GPT4oImageTool-FgiKCLOE.js.map
