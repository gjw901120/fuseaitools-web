    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (mode.value === "video-to-video") {
        ...
        if (isUploadingVideo.value) {
          ...
          _push(`<div class="wan-video-preview-wrap" data-v-2bdccb58><video${ssrRenderAttr("src", formData.videoUrls[0])} class="wan-video-preview" controls data-v-2bdccb58></video><button type="button" class="wan-video-remove" title="Remove" data-v-2bdccb58>×</button></div>`);
        } else {
...
//# sourceMappingURL=WanTool-DVQ2mFHY.js.map
