...
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderClass, ssrInterpolate, ssrIncludeBooleanAttr, ssrRenderComponent, ssrRenderStyle, ssrRenderList } from "vue/server-renderer";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (currentCredits.value !== null) {
        _push(`<span style="${ssrRenderStyle({ "margin-left": "8px", "font-weight": "500" })}" data-v-c2d3e42b> · ${ssrInterpolate(currentCredits.value)} credits`);
      ...
      if (isGenerating.value) {
        ...
        if (currentCredits.value !== null) {
          _push(`<span data-v-c2d3e42b>· ${ssrInterpolate(currentCredits.value)} credits`);
          if (discountText.value) {
            _push(`<span data-v-c2d3e42b>${ssrInterpolate(discountText.value)}</span>`);
          } else {
            _push(`<!---->`);
...
//# sourceMappingURL=GPTImageTool-DHQpYqnM.js.map
