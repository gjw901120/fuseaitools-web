    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(isSubscription)) {
        ...
        if (unref(subscriptionPackageLabel)) {
          _push(`<span class="title-package" data-v-5ba74d7e> · ${ssrInterpolate(unref(subscriptionPackageLabel))}</span>`);
        } else {
          _push(`<!---->`);
        }
...
//# sourceMappingURL=credits-CYBWqmGY.js.map
