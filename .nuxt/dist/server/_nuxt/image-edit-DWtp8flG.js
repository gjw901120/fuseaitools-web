    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-757e9341${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/qwen/image-edit.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const imageEdit = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-757e9341"]]);
export {
  imageEdit as default
};
//# sourceMappingURL=image-edit-DWtp8flG.js.map
