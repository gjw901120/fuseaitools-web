...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div></div><div class="usage-tips" data-v-365c3161><div class="tip-item" data-v-365c3161><span class="tip-icon" data-v-365c3161>✨</span><span data-v-365c3161>Provide detailed descriptive prompts for better results</span></div><div class="tip-item" data-v-365c3161><span class="tip-icon" data-v-365c3161>🖼️</span><span data-v-365c3161>Upload reference images to guide generation direction</span></div><div class="tip-item" data-v-365c3161><span class="tip-icon" data-v-365c3161>📐</span><span data-v-365c3161>Support multiple aspect ratios, choose the appropriate ratio</span></div><div class="tip-item" data-v-365c3161><span class="tip-icon" data-v-365c3161>🔄</span><span data-v-365c3161>Enable the fallback mechanism to improve generation success rate</span></div></div></div>`);
    };
  }
};
...
//# sourceMappingURL=GPT4oImageTool-DsDrJcLq.js.map
