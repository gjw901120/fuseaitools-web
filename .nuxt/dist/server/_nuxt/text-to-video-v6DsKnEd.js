...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      name: "Veo 3 Text to Video Generator",
      description: "Generate high-fidelity videos from text using Google Veo 3. Pay per video with credits.",
      category: "video",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-28691dac${_scopeId}>`);
...
const textToVideo = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-28691dac"]]);
export {
  textToVideo as default
};
//# sourceMappingURL=text-to-video-v6DsKnEd.js.map
