    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-f6320ca3${_scopeId}>`);
...
const multilingualV2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f6320ca3"]]);
export {
  multilingualV2 as default
};
//# sourceMappingURL=multilingual-v2-DX01jOlZ.js.map
