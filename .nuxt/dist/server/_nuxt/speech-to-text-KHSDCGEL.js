    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-486780c1${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/elevenlabs/speech-to-text.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const speechToText = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-486780c1"]]);
export {
  speechToText as default
};
//# sourceMappingURL=speech-to-text-KHSDCGEL.js.map
