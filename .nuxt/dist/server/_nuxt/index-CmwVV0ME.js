  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(faqItems.value, (item, index2) => {
        ...
        if (item.isOpen) {
          _push(`<div class="faq-answer" data-v-a8330cb1><div class="faq-content" data-v-a8330cb1>${item.answer ?? ""}</div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</article>`);
...
//# sourceMappingURL=index-CmwVV0ME.js.map
