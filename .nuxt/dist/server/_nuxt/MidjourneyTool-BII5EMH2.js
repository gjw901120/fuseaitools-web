...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div></div><div class="usage-tips" data-v-b532afac><div class="tip-item" data-v-b532afac><span class="tip-icon" data-v-b532afac>🎨</span><span data-v-b532afac>Describe the image you want in English; the more detailed the prompt, the better the result</span></div></div></div>`);
    };
  }
};
...
//# sourceMappingURL=MidjourneyTool-BII5EMH2.js.map
