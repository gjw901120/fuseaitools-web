...
import { ssrRenderAttrs, ssrInterpolate, ssrIncludeBooleanAttr, ssrRenderStyle, ssrRenderList, ssrRenderClass, ssrRenderTeleport } from "vue/server-renderer";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(isSubscription)) {
        ...
        if (unref(subscriptionPackageLabel)) {
          _push(`<span class="title-package" data-v-8a5f0a7d> · ${ssrInterpolate(unref(subscriptionPackageLabel))}</span>`);
        } else {
          _push(`<!---->`);
        }
...
//# sourceMappingURL=credits-B3ThZoOZ.js.map
