...
import { U as UploadAudio } from "./UploadAudio-BiE3XXaz.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isDetailView.value && detailData.value && detailData.value.status === 3) {
        ...
        if (formData.function === "multilingual-v2" || formData.function === "turbo-2-5") {
          ...
          _push(`<div class="text-result" data-v-4612dcda><div class="text-content" data-v-4612dcda><h5 data-v-4612dcda>Recognition Result</h5><div class="transcript transcript-block" data-v-4612dcda>${ssrInterpolate((((_d = speechToTextDetailResult.value) == null ? void 0 : _d.text) ?? ((_e = displayResult.value) == null ? void 0 : _e.transcript)) || "No transcript")}</div>`);
          if (sttWordsList.value.length) {
            ...
            ssrRenderList(sttWordsList.value, (w, idx) => {
              ...
              if (w.type === "word") {
                ...
                _push(`<span class="timeline-segment timeline-spacing"${ssrRenderAttr("title", `${w.start.toFixed(2)}s – ${w.end.toFixed(2)}s`)} data-v-4612dcda> </span>`);
              } else {
                _push(`<!---->`);
              }
              _push(`<!--]-->`);
          ...
          if (((_f = speechToTextDetailResult.value) == null ? void 0 : _f.language_code) || ((_h = (_g = displayResult.value) == null ? void 0 : _g.outputResults) == null ? void 0 : _h.language_code)) {
            _push(`<div class="stt-meta" data-v-4612dcda><span data-v-4612dcda>Language: ${ssrInterpolate(((_i = speechToTextDetailResult.value) == null ? void 0 : _i.language_code) ?? ((_k = (_j = displayResult.value) == null ? void 0 : _j.outputResults) == null ? void 0 : _k.language_code))}</span></div>`);
          } else {
            _push(`<!---->`);
          }
      ...
      _push(`</div></div></div><div class="usage-tips" data-v-4612dcda><div class="tip-item" data-v-4612dcda><span class="tip-icon" data-v-4612dcda>🎤</span><span data-v-4612dcda>Text-to-Speech: Supports multiple languages and voice styles, adjustable stability, similarity and style parameters</span></div><div class="tip-item" data-v-4612dcda><span class="tip-icon" data-v-4612dcda>📝</span><span data-v-4612dcda>Speech-to-Text: High-precision speech recognition with speaker identification and audio event marking</span></div><div class="tip-item" data-v-4612dcda><span class="tip-icon" data-v-4612dcda>🎵</span><span data-v-4612dcda>Sound Effect Generation: AI-driven sound effect generation with loop playback and duration control</span></div><div class="tip-item" data-v-4612dcda><span class="tip-icon" data-v-4612dcda>✂️</span><span data-v-4612dcda>AI Audio Isolation: Intelligently isolate vocals and background music</span></div></div></div>`);
    };
  }
};
...
//# sourceMappingURL=ElevenLabsTool-BKs2f907.js.map
