import { computed, ref, watch, reactive, mergeProps, unref, useSSRContext } from "vue";
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderClass, ssrIncludeBooleanAttr, ssrInterpolate, ssrRenderComponent, ssrRenderList, ssrRenderStyle } from "vue/server-renderer";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    function fillFormFromOriginalData(data) {
      ...
      if (o.nFrames !== void 0) form.input.n_frames = String(o.nFrames ?? o.n_frames ?? form.input.n_frames);
      if (o.n_frames !== void 0) form.input.n_frames = String(o.n_frames ?? form.input.n_frames);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!isDetailView.value && unref(route).path === "/home/sora/text-to-video") {
        _push(`<div class="tutorial-showcase" data-v-357d17d7><p class="tutorial-showcase-title" data-v-357d17d7>🎬 Tutorial Showcase</p><div class="tutorial-showcase-links" data-v-357d17d7><a href="/news/sora-2-landscape-text-to-video-4k-dynamic-wallpaper" class="tutorial-link" data-v-357d17d7> One Text Prompt to a 4K Dynamic Wallpaper? Sora-2 Turns Landscape Descriptions into “Breathing” Video </a><a href="/news/sora-2-portrait-text-to-video-tutorial" class="tutorial-link" data-v-357d17d7> Goodbye Stiff Photos: Turn Text Prompts into Lifelike Portrait Videos with Sora-2 </a></div></div>`);
      } else {
        _push(`<!---->`);
      }
...
//# sourceMappingURL=SoraTool-DFiQ9B8J.js.map
