  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!isDetailView.value && unref(route).path === "/home/seedance/v1-5-pro") {
        _push(`<div class="tutorial-showcase" data-v-72b4a276><p class="tutorial-showcase-title" data-v-72b4a276>🎬 Tutorial Showcase</p><div class="tutorial-showcase-links" data-v-72b4a276><a href="/news/seedance-nezha-i2v-props-race-tutorial" class="tutorial-link" data-v-72b4a276> From Images to Video: Seedance I2V — Props Race &amp; Fight (Nezha &amp; Ao Bing) — sample workflow &amp; video </a></div></div>`);
      } else {
        _push(`<!---->`);
      }
...
//# sourceMappingURL=SeedanceTool-BJKhi7aP.js.map
