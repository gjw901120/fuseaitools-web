...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div></div>`);
      if (activeTab.value === "generate") {
        _push(`<div class="usage-tips" data-v-e8dceb8a><div class="tip-item" data-v-e8dceb8a><span class="tip-icon" data-v-e8dceb8a>📝</span><span data-v-e8dceb8a><strong data-v-e8dceb8a>Detailed Description:</strong> Include details like scenes, actions, camera movement, lighting, etc.</span></div><div class="tip-item" data-v-e8dceb8a><span class="tip-icon" data-v-e8dceb8a>🎬</span><span data-v-e8dceb8a><strong data-v-e8dceb8a>Cinematic Terms:</strong> Use professional terms like &quot;close-up&quot;, &quot;wide shot&quot;, &quot;tracking shot&quot;</span></div><div class="tip-item" data-v-e8dceb8a><span class="tip-icon" data-v-e8dceb8a>🎨</span><span data-v-e8dceb8a><strong data-v-e8dceb8a>Style Specification:</strong> Such as &quot;sci-fi style&quot;, &quot;romantic comedy&quot;, &quot;action film&quot;</span></div><div class="tip-item" data-v-e8dceb8a><span class="tip-icon" data-v-e8dceb8a>⏱️</span><span data-v-e8dceb8a><strong data-v-e8dceb8a>Duration Limit:</strong> 10-second videos do not support 1080p resolution</span></div><div class="tip-item" data-v-e8dceb8a><span class="tip-icon" data-v-e8dceb8a>🖼️</span><span data-v-e8dceb8a><strong data-v-e8dceb8a>Reference Image:</strong> Providing an image URL can add animation effects to existing images</span></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (activeTab.value === "aleph") {
        _push(`<div class="usage-tips" data-v-e8dceb8a><div class="tip-item" data-v-e8dceb8a><span class="tip-icon" data-v-e8dceb8a>🔄</span><span data-v-e8dceb8a><strong data-v-e8dceb8a>Transformation Description:</strong> Focus on describing the style changes and effect transformations you want</span></div><div class="tip-item" data-v-e8dceb8a><span class="tip-icon" data-v-e8dceb8a>📹</span><span data-v-e8dceb8a><strong data-v-e8dceb8a>Motion Effects:</strong> Use camera movement terminology to enhance video dynamics</span></div><div class="tip-item" data-v-e8dceb8a><span class="tip-icon" data-v-e8dceb8a>⏰</span><span data-v-e8dceb8a><strong data-v-e8dceb8a>Temporal Control:</strong> Control transformation rhythm through temporal elements (gradually, suddenly, etc.)</span></div><div class="tip-item" data-v-e8dceb8a><span class="tip-icon" data-v-e8dceb8a>🎥</span><span data-v-e8dceb8a><strong data-v-e8dceb8a>Video Requirements:</strong> Ensure video URL is accessible via HTTPS and file size does not exceed 10MB</span></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (activeTab.value === "extend") {
        _push(`<div class="usage-tips" data-v-e8dceb8a><div class="tip-item" data-v-e8dceb8a><span class="tip-icon" data-v-e8dceb8a>➡️</span><span data-v-e8dceb8a><strong data-v-e8dceb8a>Continuation Description:</strong> Describe what should happen next in the video sequence</span></div><div class="tip-item" data-v-e8dceb8a><span class="tip-icon" data-v-e8dceb8a>🔗</span><span data-v-e8dceb8a><strong data-v-e8dceb8a>Consistency:</strong> Maintain visual and narrative consistency with the original video</span></div><div class="tip-item" data-v-e8dceb8a><span class="tip-icon" data-v-e8dceb8a>⚡</span><span data-v-e8dceb8a><strong data-v-e8dceb8a>Dynamic Actions:</strong> Specify movements, actions, and developments clearly</span></div><div class="tip-item" data-v-e8dceb8a><span class="tip-icon" data-v-e8dceb8a>🎯</span><span data-v-e8dceb8a><strong data-v-e8dceb8a>Quality Selection:</strong> Choose resolution based on your needs - 720p for faster generation, 1080p for higher quality</span></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
//# sourceMappingURL=RunwayTool-g_LnVW9X.js.map
