  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(faqItems.value, (item, index2) => {
        ...
        if (item.isOpen) {
          _push(`<div class="faq-answer" data-v-b21f831d><div class="faq-content" data-v-b21f831d>${item.answer ?? ""}</div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</article>`);
...
//# sourceMappingURL=index-C7uIg7fC.js.map
