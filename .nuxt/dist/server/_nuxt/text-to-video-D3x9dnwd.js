    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-5d55f378${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/wan/text-to-video.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const textToVideo = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5d55f378"]]);
export {
  textToVideo as default
};
//# sourceMappingURL=text-to-video-D3x9dnwd.js.map
