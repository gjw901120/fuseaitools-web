...
const assets = {
  "/index.mjs": {
    ...
    "etag": "\"387d0-sQSVJSAnDEOVuaS+V6QDgvn0DgQ\"",
    "mtime": "2026-03-26T08:02:09.232Z",
    "size": 231376,
    "path": "index.mjs"
  },
  "/index.mjs.map": {
    "type": "application/json",
    "etag": "\"b2c5d-FWDsp11NF5y1L5qd+pv0jHvby5o\"",
    "mtime": "2026-03-26T08:02:09.237Z",
    "size": 732253,
    "path": "index.mjs.map"
  }
};
...
const _lazy_XK6oKJ = () => Promise.resolve().then(function () { return generate_post$j; });
...
const _lazy_5Wj7I0 = () => Promise.resolve().then(function () { return fastGenerate_post$1; });
const _lazy_Un69FN = () => Promise.resolve().then(function () { return generate_post$h; });
const _lazy_OasX5f = () => Promise.resolve().then(function () { return ultraGenerate_post$1; });
...
const _lazy_Dtnlru = () => Promise.resolve().then(function () { return pro15ImageToVideo_post$1; });
...
const generate_post$p = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: generate_post$o
}, Symbol.toStringTag, { value: 'Module' }));
...
const fastGenerate_post = defineEventHandler(async (event) => {
  const body = await readBody(event);
  const apiBase = getEffectiveApiBase(event);
...
const fastGenerate_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: fastGenerate_post
}, Symbol.toStringTag, { value: 'Module' }));

const generate_post$g = defineEventHandler(async (event) => {
  const body = await readBody(event);
  const apiBase = getEffectiveApiBase(event);
  const targetUrl = `${apiBase}/image/imagen4/generate`;
  try {
    const authHeader = getHeader(event, "authorization");
    const headers = { "Content-Type": "application/json", Accept: "application/json" };
    if (authHeader) headers["Authorization"] = authHeader;
...
const ultraGenerate_post = defineEventHandler(async (event) => {
  const body = await readBody(event);
  const apiBase = getEffectiveApiBase(event);
  const targetUrl = `${apiBase}/image/imagen4/ultra-generate`;
  try {
    const authHeader = getHeader(event, "authorization");
    const headers = { "Content-Type": "application/json", Accept: "application/json" };
    if (authHeader) headers["Authorization"] = authHeader;
    ...
    console.error("Imagen4 ultra-generate proxy error:", error);
    throw createError({ statusCode: 500, message: "Request failed: " + (error.message || "Unknown error") });
  }
});

const ultraGenerate_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: ultraGenerate_post
}, Symbol.toStringTag, { value: 'Module' }));
...
const pro15ImageToVideo_post = defineEventHandler(async (event) => {
  const body = await readBody(event);
  const apiBase = getEffectiveApiBase(event);
...
const pro15ImageToVideo_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: pro15ImageToVideo_post
}, Symbol.toStringTag, { value: 'Module' }));
