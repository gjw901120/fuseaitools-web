    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-b98d0b4e${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/gpt-image/text-to-image.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const textToImage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b98d0b4e"]]);

export { textToImage as default };
//# sourceMappingURL=text-to-image-lteVmi0P.mjs.map
