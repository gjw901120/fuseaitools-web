import { _ as __nuxt_component_0$1 } from './HomeLayout-BhPmJPes.mjs';
import { _ as __nuxt_component_0$2 } from './nuxt-link-BgkIFP7n.mjs';
import { computed, withCtx, createVNode, toDisplayString, createBlock, createCommentVNode, openBlock, createTextVNode, Fragment, renderList, useSSRContext } from 'file://C:/project/fuseaitools-web/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderClass, ssrRenderList } from 'file://C:/project/fuseaitools-web/node_modules/vue/server-renderer/index.mjs';
import { _ as _export_sfc, d as useRoute$1 } from './server.mjs';
import { u as useHead } from './v3-DXSoGrP9.mjs';
import { useRoute } from 'file://C:/project/fuseaitools-web/node_modules/vue-router/dist/vue-router.node.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-overview content-padding" data-v-dd39b7c8${_scopeId}><header class="overview-header" data-v-dd39b7c8${_scopeId}>`);
            if (__props.config.showCategory !== false) {
              _push2(`<span class="overview-category" data-v-dd39b7c8${_scopeId}>${ssrInterpolate(__props.config.category)}</span>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="overview-title-row" data-v-dd39b7c8${_scopeId}>`);
            if (__props.config.logo) {
              _push2(`<img${ssrRenderAttr("src", __props.config.logo)} alt="" class="overview-title-logo" data-v-dd39b7c8${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<h1 class="overview-title" data-v-dd39b7c8${_scopeId}>${ssrInterpolate(__props.config.title)}</h1></div><p class="${ssrRenderClass([{ "intro-full-width": __props.config.introFullWidth }, "overview-intro"])}" data-v-dd39b7c8${_scopeId}>${ssrInterpolate(__props.config.intro)}</p></header><section class="overview-features" data-v-dd39b7c8${_scopeId}><h2 class="features-heading" data-v-dd39b7c8${_scopeId}><i class="fas fa-th-large features-heading-icon" data-v-dd39b7c8${_scopeId}></i> Features </h2><div class="features-grid" data-v-dd39b7c8${_scopeId}><!--[-->`);
            ssrRenderList(__props.config.features, (feature) => {
              _push2(ssrRenderComponent(_component_NuxtLink, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="feature-card" data-v-dd39b7c8${_scopeId2}><div class="feature-icon" data-v-dd39b7c8${_scopeId2}><i class="fas fa-arrow-right" data-v-dd39b7c8${_scopeId2}></i></div><h3 class="feature-title" data-v-dd39b7c8${_scopeId2}>${ssrInterpolate(feature.name)}</h3><p class="feature-description" data-v-dd39b7c8${_scopeId2}>${ssrInterpolate(feature.description)}</p><span class="feature-cta" data-v-dd39b7c8${_scopeId2}>Use this feature \u2192</span></div>`);
                  } else {
                    return [
            ...
            _push2(`<!--]--></div></section>`);
            if (__props.config.sections && __props.config.sections.length) {
              _push2(`<div class="sections-wrapper" data-v-dd39b7c8${_scopeId}><!--[-->`);
              ssrRenderList(__props.config.sections, (section, idx) => {
                _push2(`<section class="overview-section" data-v-dd39b7c8${_scopeId}><h2 class="section-title" data-v-dd39b7c8${_scopeId}>${ssrInterpolate(section.title)}</h2><div class="section-content" data-v-dd39b7c8${_scopeId}><!--[-->`);
                ssrRenderList(sectionParagraphs(section.content), (para, i) => {
                  _push2(`<p class="section-para" data-v-dd39b7c8${_scopeId}>${ssrInterpolate(para)}</p>`);
                });
                _push2(`<!--]--></div></section>`);
              });
              _push2(`<!--]--></div>`);
            ...
            return [
              createVNode("div", { class: "tool-overview content-padding" }, [
                createVNode("header", { class: "overview-header" }, [
                  __props.config.showCategory !== false ? (openBlock(), createBlock("span", {
                    key: 0,
                    class: "overview-category"
                  }, toDisplayString(__props.config.category), 1)) : createCommentVNode("", true),
                  createVNode("div", { class: "overview-title-row" }, [
                    __props.config.logo ? (openBlock(), createBlock("img", {
                      key: 0,
                      src: __props.config.logo,
                      alt: "",
                      class: "overview-title-logo"
                    }, null, 8, ["src"])) : createCommentVNode("", true),
                    createVNode("h1", { class: "overview-title" }, toDisplayString(__props.config.title), 1)
                  ]),
                  createVNode("p", {
                    class: ["overview-intro", { "intro-full-width": __props.config.introFullWidth }]
                  }, toDisplayString(__props.config.intro), 3)
                ]),
                createVNode("section", { class: "overview-features" }, [
                  createVNode("h2", { class: "features-heading" }, [
                    createVNode("i", { class: "fas fa-th-large features-heading-icon" }),
                ...
                __props.config.sections && __props.config.sections.length ? (openBlock(), createBlock("div", {
                  key: 0,
                  class: "sections-wrapper"
                }, [
                  (openBlock(true), createBlock(Fragment, null, renderList(__props.config.sections, (section, idx) => {
                    return openBlock(), createBlock("section", {
                      key: idx,
                      class: "overview-section"
                    }, [
                      createVNode("h2", { class: "section-title" }, toDisplayString(section.title), 1),
                      createVNode("div", { class: "section-content" }, [
                        (openBlock(true), createBlock(Fragment, null, renderList(sectionParagraphs(section.content), (para, i) => {
                          return openBlock(), createBlock("p", {
                            key: i,
                            class: "section-para"
                          }, toDisplayString(para), 1);
                        }), 128))
                      ])
                    ]);
                  }), 128))
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-dd39b7c8"]]);
const toolOverviews = {
  gpt: {
    title: "GPT",
    category: "Chat",
...
Tool use: Search\u2014real-time web, fact-check, multi-language. Maps\u2014location, local business, traffic, routes, geo analysis. Code execution\u2014multiple languages, data and viz, API calls, compute and simulation. Planning\u2014task decomposition, step ordering, resource use, progress tracking.`
  ...
  "gpt-image": {
    ...
    features: [
      { name: "Text to Image", path: "/home/gpt-image/generate", description: "Generate images from complex text descriptions or reference images, with precise control over aspect ratio and quality." },
      { name: "Conversational Editing", path: "/home/gpt-image/generate", description: "Add, remove, or modify elements using natural language commands within the chat; supports style transfer based on reference images and parametric fine-tuning." }
    ],
    sections: [
      {
...
Future Roadmap: Will support more detailed dynamic image generation, 2D-to-3D capabilities, and real-time collaboration features, with specialized editions planned for enterprises, educational institutions, and professional creators.`
  ...
  ideogram: {
    ...
    features: [
      { name: "v3-text-to-image", path: "/home/ideogram/generate", description: "Generate images from rich natural language prompts, with optional rendering speed, style, prompt expansion, image size, seed, and negative prompt controls." },
      { name: "v3-edit", path: "/home/ideogram/generate", description: "Mask-based image editing: upload an image and mask, then fill or modify the masked region with a new prompt." },
      { name: "v3-remix", path: "/home/ideogram/generate", description: "Remix an existing image with a new prompt, controlling strength, style, size, speed, seed, and negative prompt." },
      { name: "v3-reframe", path: "/home/ideogram/generate", description: "Reframe an image into new aspect ratios and resolutions (square, portrait, landscape), with optional style, speed, and multi-image outputs." },
      { name: "character", path: "/home/ideogram/generate", description: "Generate character-centric scenes from reference images, preserving identity while changing setting, pose, or style." },
      { name: "character-edit", path: "/home/ideogram/generate", description: "Edit part of a character image using masks and reference images to adjust looks, clothing, or pose while keeping identity." },
      { name: "character-remix", path: "/home/ideogram/generate", description: "Remix character images with new prompts and style references, controlling strength, size, and negative prompts for nuanced variations." }
    ],
    sections: [
      {
        title: "Core Features",
...
Control: Style\u2014movements (Renaissance, Baroque, Impressionist, Modern), techniques (oil, watercolor, sketch, digital), era (classical, retro, modern, futurist), culture. Composition\u2014viewpoint (macro to micro), foreground/mid/background, selective focus and depth; visual balance and rhythm. Lighting and color\u2014natural, studio, dramatic, cinematic; color theory; mood and time of day.`
      ...
      {
        title: "Technical specs",
        content: `Pro: 2048\xD72048, 24-bit, PNG/JPG/WEBP, smart compression. Max: Up to 4096\xD74096, Adobe RGB/ProPhoto RGB, TIFF/PSD, CMYK for print. Speed: Pro ~15\u201330s, Max ~45\u201390s per image; batch 10+; queue and priority.`
      },
      {
        title: "Professional workflow",
  ...
  "nano-banana": {
    ...
    features: [
      { name: "Text to Image", path: "/home/nano-banana/generate", description: "Sub-20s generation; social sizes (1080\xD71080, 1080\xD71920), web and 16:9; style and mood presets." },
...
Quality\u2013efficiency balance: Smart quality retention at speed; adaptive quality by need; smooth path from quick draft to refined version; batch-optimized throughput.`
      ...
      {
        title: "Core capabilities",
        content: `Text to Image: Fast ideation and concept visualization. Sub-20s average; live preview; high-frequency iteration; parallel requests. Sizes: social (1080\xD71080, 1080\xD71920), web (1200\xD7630, 1200\xD7800), 16:9 (1920\xD71080), 4:3 (1200\xD7900), mobile. Style presets: minimal, colorful, retro, modern; themes (business, tech, nature, food); mood (joy, serious, warm, mysterious). Use for brainstorm, A/B tests, fast feedback, batch exploration.
...
Pro Generate: Production-ready assets. Up to 4K; micro detail and color accuracy; pro formats and color spaces. Control: composition (rule of thirds, golden ratio, symmetry, viewpoint, focus, balance); style (strength, blend, per-detail, culture); lighting and color (studio, natural, dramatic, cinematic; color theory; mood; brand).`
  ...
  midjourney: {
    ...
    features: [
      ...
      { name: "Upscale", path: "/home/midjourney/upscale", description: "2\xD7, 4\xD7, 8\xD7 upscale with detail reconstruction, edge and texture preservation, batch support." },
...
Upscale: Detail reconstruction, sharp edges, preserved texture, denoising. Modes: 2\xD7, 4\xD7, 8\xD7; creative upscale with added detail; batch; progressive. For print (posters, books, exhibitions), digital (web, apps), concept presentation, and commercial assets.
...
Vary: Subtle tweaks or bold new directions; style transfer; composition and viewpoint changes. Control variation strength, preserve key features, guide with text, generate multiple variants. For concept exploration, style tests, iteration, and combining elements from variants.`
      ...
      {
        title: "Technical specs",
        content: `Image: Default 1024\xD71024; upscale to 4096\xD74096; PNG, JPG, WEBP; sRGB, Adobe RGB. Performance: Minute-level generation; batch prompts; queue and priority; full history and versioning.`
      },
      {
        title: "Professional workflow",
...
Size options: Square (1024\xD71024), square_hd (1536\xD71536), portrait 3:4 (864\xD71152), portrait 9:16 (768\xD71344), landscape 4:3 (1152\xD7864), landscape 16:9 (1344\xD7768).
...
Individual creators: YouTubers and TikTokers, digital artists, educators for teaching materials, and founders for product demos.`
      ...
      {
        title: "Technical specs",
        content: `Input: Text in multiple languages; images in JPG/PNG (e.g. 1920\xD71080 or higher); video in MP4 within duration limits.

Output: Up to 1080p (1920\xD71080), 24fps or 30fps, MP4 (H.264). Clip length typically from a few seconds up to 60 seconds. Optional watermark handling.`
      },
      {
        title: "Use cases",
...
Pro Storyboard: Shot planning, timing and transitions, dynamic preview, team comments. Industry formats, PDF/video/web export, versioning, and links to shoot plans and budgets.`
  ...
  wan: {
    ...
    features: [
      ...
      { name: "Image to Video", path: "/home/wan/image-to-video", description: "Animate static images with text guidance. Provide image URLs (min 256\xD7256px; JPEG, PNG, WebP; max 10MB), add a prompt describing the motion or scene, and set duration, resolution, and multi-shot style. Perfect for bringing illustrations, product shots, or concept art to life." },
...
Input: Image URL(s) required; minimum 256\xD7256px; formats JPEG, PNG, WebP; max 10MB per image.
...
Image quality: For image-to-video, higher resolution inputs (ideally 1024\xD71024 or larger) yield smoother animations.
...
Image to Video: Input image URL (JPEG, PNG, WebP; max 10MB; min 256\xD7256px). Optional end image URL for controlled transitions. Same resolution, duration, camera, and seed controls as text-to-video.
...
export { __nuxt_component_0 as _, useToolOverviewPage as u };
//# sourceMappingURL=useToolOverviewPage-BAdS1AGq.mjs.map
