...
const _sfc_main = {
  ...
  setup(__props) {
    const seoConfig = useToolSEO({
      ...
      description: "Seedance v1 Pro Fast Image to Video - Fast image-to-video, 720p/1080p, 5s/10s.",
      category: "video",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-fa62dbb4${_scopeId}>`);
...
const v1ProFastImageToVideo = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fa62dbb4"]]);

export { v1ProFastImageToVideo as default };
//# sourceMappingURL=v1-pro-fast-image-to-video-DFstDm7c.mjs.map
