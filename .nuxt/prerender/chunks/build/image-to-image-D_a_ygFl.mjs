...
import { Q as QwenTool } from './QwenTool-BCSQgqO3.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      name: "Qwen Image to Image Generator",
      description: "Generate from reference image and prompt with Qwen. Pay per image with credits.",
      category: "image",
      route: "/home/qwen/image-to-image",
      keywords: ["Qwen", "Image to Image", "AI image"],
      applicationCategory: "MultimediaApplication",
      applicationSubCategory: "Image Generation",
      offers: { price: "0", priceCurrency: "USD" },
      offerDescription: "Pay per image with credits.",
      priceFromApi: { modelKey: "qwen-image-to-image", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-6d57eb3d${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/qwen/image-to-image.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const imageToImage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6d57eb3d"]]);

export { imageToImage as default };
//# sourceMappingURL=image-to-image-D_a_ygFl.mjs.map
