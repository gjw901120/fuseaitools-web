...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      ...
      description: "Create and edit images with ChatGPT 4o Image. Pay per image with credits.",
      category: "image",
      ...
      priceFromApi: { modelKey: "GPT_4o_image", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-14fc90ce${_scopeId}>`);
...
const generate = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-14fc90ce"]]);

export { generate as default };
//# sourceMappingURL=generate-Dyl1sWkS.mjs.map
