  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!isDetailView.value && unref(route).path === "/home/seedance/v1-5-pro") {
        _push(`<div class="tutorial-showcase" data-v-c858fcb0><p class="tutorial-showcase-title" data-v-c858fcb0>\u{1F3AC} Tutorial Showcase</p><div class="tutorial-showcase-links" data-v-c858fcb0><a href="/news/seedance-nezha-i2v-props-race-tutorial" class="tutorial-link" data-v-c858fcb0> From Images to Video: Seedance I2V \u2014 Props Race &amp; Fight (Nezha &amp; Ao Bing) \u2014 sample workflow &amp; video </a></div></div>`);
      } else {
        _push(`<!---->`);
      }
...
//# sourceMappingURL=SeedanceTool-pOSlYk0M.mjs.map
