...
const _sfc_main = {
  __name: "qwen2-text-to-image",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      name: "Qwen2 Text to Image",
      description: "Generate images with qwen2-image-edit model. Pay per image with credits.",
      category: "image",
      route: "/home/qwen/qwen2-text-to-image",
      keywords: ["Qwen2", "Text to Image", "AI image"],
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-59829008${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/qwen/qwen2-text-to-image.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const qwen2TextToImage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-59829008"]]);

export { qwen2TextToImage as default };
//# sourceMappingURL=qwen2-text-to-image-BXI1IHvg.mjs.map
