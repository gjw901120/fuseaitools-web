...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      ...
      description: "Extend existing music with Suno AI. Pay per extend with credits.",
      category: "audio",
      ...
      offerDescription: "Consumes credits per extend. Credits are purchased separately.",
      priceFromApi: { modelKey: "suno_extend", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-0ccc1e7f${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/suno/extend.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const extend = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0ccc1e7f"]]);

export { extend as default };
//# sourceMappingURL=extend-ZhRt1Jy0.mjs.map
