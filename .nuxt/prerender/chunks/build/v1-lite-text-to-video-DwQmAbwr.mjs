...
const _sfc_main = {
  ...
  setup(__props) {
    const seoConfig = useToolSEO({
      ...
      description: "Seedance v1 Lite Text to Video - Generate AI video from text. Aspect ratio 16:9\u20139:21, 480p/720p/1080p, 5s/10s.",
      category: "video",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-7230d6f5${_scopeId}>`);
...
const v1LiteTextToVideo = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7230d6f5"]]);

export { v1LiteTextToVideo as default };
//# sourceMappingURL=v1-lite-text-to-video-DwQmAbwr.mjs.map
