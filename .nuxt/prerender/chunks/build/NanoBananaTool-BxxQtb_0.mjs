...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div></div>`);
      if (activeTab.value === "nano-banana") {
        _push(`<div class="usage-tips" data-v-af879f3b><div class="tip-item" data-v-af879f3b><span class="tip-icon" data-v-af879f3b>\u270D\uFE0F</span><span data-v-af879f3b><strong data-v-af879f3b>Text to Image:</strong> Describe the image content you want to generate</span></div><div class="tip-item" data-v-af879f3b><span class="tip-icon" data-v-af879f3b>\u{1F4DD}</span><span data-v-af879f3b><strong data-v-af879f3b>Character Limit:</strong> Prompt supports up to 5000 characters</span></div><div class="tip-item" data-v-af879f3b><span class="tip-icon" data-v-af879f3b>\u{1F5BC}\uFE0F</span><span data-v-af879f3b><strong data-v-af879f3b>Format Selection:</strong> PNG supports transparent background, JPEG files are smaller</span></div><div class="tip-item" data-v-af879f3b><span class="tip-icon" data-v-af879f3b>\u{1F4D0}</span><span data-v-af879f3b><strong data-v-af879f3b>Size Selection:</strong> Choose the appropriate aspect ratio or select auto for AI to decide</span></div><div class="tip-item" data-v-af879f3b><span class="tip-icon" data-v-af879f3b>\u26A1</span><span data-v-af879f3b><strong data-v-af879f3b>Lightweight:</strong> Nano Banana is optimized for fast generation</span></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (activeTab.value === "nano-banana-edit") {
        _push(`<div class="usage-tips" data-v-af879f3b><div class="tip-item" data-v-af879f3b><span class="tip-icon" data-v-af879f3b>\u{1F4E4}</span><span data-v-af879f3b><strong data-v-af879f3b>Image to Image:</strong> Upload 1\u201310 images in JPG/PNG/WEBP format to edit</span></div><div class="tip-item" data-v-af879f3b><span class="tip-icon" data-v-af879f3b>\u270D\uFE0F</span><span data-v-af879f3b><strong data-v-af879f3b>Edit Prompt:</strong> Describe the edits you want to make to the uploaded images</span></div><div class="tip-item" data-v-af879f3b><span class="tip-icon" data-v-af879f3b>\u{1F4DD}</span><span data-v-af879f3b><strong data-v-af879f3b>Character Limit:</strong> Prompt supports up to 5000 characters</span></div><div class="tip-item" data-v-af879f3b><span class="tip-icon" data-v-af879f3b>\u{1F5BC}\uFE0F</span><span data-v-af879f3b><strong data-v-af879f3b>Format &amp; Size:</strong> Choose output format and aspect ratio for the result</span></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (activeTab.value === "nano-banana-pro") {
        _push(`<div class="usage-tips" data-v-af879f3b><div class="tip-item" data-v-af879f3b><span class="tip-icon" data-v-af879f3b>\u270D\uFE0F</span><span data-v-af879f3b><strong data-v-af879f3b>Prompt:</strong> Provide detailed image descriptions, supports up to 20000 characters for complex scenes</span></div><div class="tip-item" data-v-af879f3b><span class="tip-icon" data-v-af879f3b>\u{1F5BC}\uFE0F</span><span data-v-af879f3b><strong data-v-af879f3b>Input Images:</strong> Upload up to 8 images as reference or for transformation, max 30MB per image</span></div><div class="tip-item" data-v-af879f3b><span class="tip-icon" data-v-af879f3b>\u{1F4D0}</span><span data-v-af879f3b><strong data-v-af879f3b>Aspect Ratio:</strong> Choose the appropriate aspect ratio for your use case, or select &quot;auto&quot; for automatic selection</span></div><div class="tip-item" data-v-af879f3b><span class="tip-icon" data-v-af879f3b>\u{1F3AF}</span><span data-v-af879f3b><strong data-v-af879f3b>Resolution:</strong> Select 1K, 2K, or 4K resolution based on your quality requirements</span></div><div class="tip-item" data-v-af879f3b><span class="tip-icon" data-v-af879f3b>\u{1F4BE}</span><span data-v-af879f3b><strong data-v-af879f3b>Output Format:</strong> PNG supports transparent background, JPG files are smaller in size</span></div><div class="tip-item" data-v-af879f3b><span class="tip-icon" data-v-af879f3b>\u2B50</span><span data-v-af879f3b><strong data-v-af879f3b>Pro Features:</strong> Nano Banana Pro offers enhanced image generation capabilities with higher quality output</span></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
//# sourceMappingURL=NanoBananaTool-BxxQtb_0.mjs.map
