...
const _sfc_main = {
  ...
  setup(__props) {
    const seoConfig = useToolSEO({
      name: "Luma",
      description: "Use Luma for free online. 3D AI video generation tool creating realistic 3D video content from text or images. Supports multiple 3D scenes, effects, and video modification. Revolutionary 3D video creation experience.",
      category: "video",
      route: "/home/luma/generate",
      keywords: ["Luma", "3D AI video", "3D video generation", "AI 3D", "3D video production", "3D video creation", "video modification", "AI video", "3D video maker"],
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-d8c384a6${_scopeId}>`);
            _push2(ssrRenderComponent(LumaTool, null, null, _parent2, _scopeId));
            _push2(`</div>`);
          } else {
            return [
              createVNode("div", { class: "tool-page" }, [
                createVNode(LumaTool)
              ])
            ];
          }
        }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/luma/generate.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const generate = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d8c384a6"]]);

export { generate as default };
//# sourceMappingURL=generate-Af-pKlqy.mjs.map
