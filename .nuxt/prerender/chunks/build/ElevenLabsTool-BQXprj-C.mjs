...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const getButtonLabel = () => {
      ...
      return `${getButtonText()} \xB7 ${price}`;
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isDetailView.value && detailData.value && detailData.value.status === 3) {
        ...
        if (formData.function === "multilingual-v2" || formData.function === "turbo-2-5") {
          ...
          _push(`<div class="text-result" data-v-e1ee8db8><div class="text-content" data-v-e1ee8db8><h5 data-v-e1ee8db8>Recognition Result</h5><div class="transcript transcript-block" data-v-e1ee8db8>${ssrInterpolate(((_a2 = (_d = speechToTextDetailResult.value) == null ? void 0 : _d.text) != null ? _a2 : (_e = displayResult.value) == null ? void 0 : _e.transcript) || "No transcript")}</div>`);
          if (sttWordsList.value.length) {
            ...
            ssrRenderList(sttWordsList.value, (w, idx) => {
              ...
              if (w.type === "word") {
                ...
                _push(`<span class="timeline-segment timeline-spacing"${ssrRenderAttr("title", `${w.start.toFixed(2)}s \u2013 ${w.end.toFixed(2)}s`)} data-v-e1ee8db8>\xA0</span>`);
              } else {
                _push(`<!---->`);
              }
              _push(`<!--]-->`);
          ...
          if (((_f = speechToTextDetailResult.value) == null ? void 0 : _f.language_code) || ((_h = (_g = displayResult.value) == null ? void 0 : _g.outputResults) == null ? void 0 : _h.language_code)) {
            _push(`<div class="stt-meta" data-v-e1ee8db8><span data-v-e1ee8db8>Language: ${ssrInterpolate((_b2 = (_i = speechToTextDetailResult.value) == null ? void 0 : _i.language_code) != null ? _b2 : (_k = (_j = displayResult.value) == null ? void 0 : _j.outputResults) == null ? void 0 : _k.language_code)}</span></div>`);
          } else {
            _push(`<!---->`);
          }
      ...
      _push(`</div></div></div><div class="usage-tips" data-v-e1ee8db8><div class="tip-item" data-v-e1ee8db8><span class="tip-icon" data-v-e1ee8db8>\u{1F3A4}</span><span data-v-e1ee8db8>Text-to-Speech: Supports multiple languages and voice styles, adjustable stability, similarity and style parameters</span></div><div class="tip-item" data-v-e1ee8db8><span class="tip-icon" data-v-e1ee8db8>\u{1F4DD}</span><span data-v-e1ee8db8>Speech-to-Text: High-precision speech recognition with speaker identification and audio event marking</span></div><div class="tip-item" data-v-e1ee8db8><span class="tip-icon" data-v-e1ee8db8>\u{1F3B5}</span><span data-v-e1ee8db8>Sound Effect Generation: AI-driven sound effect generation with loop playback and duration control</span></div><div class="tip-item" data-v-e1ee8db8><span class="tip-icon" data-v-e1ee8db8>\u2702\uFE0F</span><span data-v-e1ee8db8>AI Audio Isolation: Intelligently isolate vocals and background music</span></div></div></div>`);
    };
  }
};
...
//# sourceMappingURL=ElevenLabsTool-BQXprj-C.mjs.map
