...
import { G as GPTImageTool } from './GPTImageTool-Kipx2jty.mjs';
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      ...
      description: "Edit or transform images with reference and prompt using GPT Image. Pay per image with credits.",
      category: "image",
      route: "/home/gpt-image/image-to-image",
      keywords: ["GPT Image", "OpenAI", "Image to Image", "AI image editing"],
      applicationCategory: "MultimediaApplication",
      applicationSubCategory: "Image Generation",
      offers: { price: "0", priceCurrency: "USD" },
      offerDescription: "Pay per image with credits.",
      priceFromApi: { modelKey: "gpt-image-1.5-image-to-image", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-d25f888e${_scopeId}>`);
            _push2(ssrRenderComponent(GPTImageTool, null, null, _parent2, _scopeId));
            _push2(`</div>`);
          } else {
            return [
              createVNode("div", { class: "tool-page" }, [
                createVNode(GPTImageTool)
              ])
            ];
          }
        }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/gpt-image/image-to-image.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const imageToImage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d25f888e"]]);

export { imageToImage as default };
//# sourceMappingURL=image-to-image-BVlVvm3b.mjs.map
