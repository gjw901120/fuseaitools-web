...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      ...
      description: "Recreate audio with Suno AI from uploaded cover. Pay per generation with credits.",
      category: "audio",
      route: "/home/suno/upload-cover",
      keywords: ["Suno", "Audio Cover", "AI music"],
      ...
      priceFromApi: { modelKey: "suno_upload_cover", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-dfc3d351${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/suno/upload-cover.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const uploadCover = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-dfc3d351"]]);

export { uploadCover as default };
//# sourceMappingURL=upload-cover-KBSHBd-u.mjs.map
