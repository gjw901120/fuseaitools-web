...
import { I as Imagen4Tool } from './Imagen4Tool-CFZ-bQeX.mjs';
...
const _sfc_main = {
  __name: "imagen4-generate",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      name: "Imagen4 Generate",
      description: "Generate images with Imagen4 Generate using prompt, optional negative prompt, aspect ratio, and seed controls.",
      category: "image",
      route: "/home/imagen4/imagen4-generate",
      keywords: ["Imagen4", "text to image", "AI image", "Google Imagen 4"],
      applicationCategory: "MultimediaApplication",
      applicationSubCategory: "Image Generation",
      offers: { price: "0", priceCurrency: "USD" },
      offerDescription: "Pay per image with credits.",
      priceFromApi: { modelKey: "imagen4-generate", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-c4ba06a1${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/imagen4/imagen4-generate.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const imagen4Generate = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c4ba06a1"]]);

export { imagen4Generate as default };
//# sourceMappingURL=imagen4-generate-BTicUwNt.mjs.map
