...
const _sfc_main = {
  ...
  setup(__props) {
    const seoConfig = useToolSEO({
      ...
      description: "Seedance v1 Lite Image to Video - Animate images with text. Resolution 480p/720p/1080p, 5s/10s, optional end image.",
      category: "video",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-bc5384c7${_scopeId}>`);
...
const v1LiteImageToVideo = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-bc5384c7"]]);

export { v1LiteImageToVideo as default };
//# sourceMappingURL=v1-lite-image-to-video-4ZOxjwcN.mjs.map
