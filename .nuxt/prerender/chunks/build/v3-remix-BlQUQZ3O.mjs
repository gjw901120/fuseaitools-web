...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      ...
      description: "Remix images with strength and style control using Ideogram V3. Pay per image with credits.",
      category: "image",
      route: "/home/ideogram/v3-remix",
      keywords: ["Ideogram", "V3", "Remix", "AI image remix"],
      applicationCategory: "MultimediaApplication",
      applicationSubCategory: "Image Generation",
      offers: { price: "0", priceCurrency: "USD" },
      offerDescription: "Pay per image with credits.",
      priceFromApi: { modelKey: "ideogram-v3-remix", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-6271341d${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/ideogram/v3-remix.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const v3Remix = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6271341d"]]);

export { v3Remix as default };
//# sourceMappingURL=v3-remix-BlQUQZ3O.mjs.map
