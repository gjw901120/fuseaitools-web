    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-b6484581${_scopeId}>`);
...
const imageEdit = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b6484581"]]);

export { imageEdit as default };
//# sourceMappingURL=image-edit-BSzx9qpy.mjs.map
