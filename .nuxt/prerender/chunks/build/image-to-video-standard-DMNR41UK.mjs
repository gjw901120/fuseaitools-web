...
const _sfc_main = {
  __name: "image-to-video-standard",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-ac085327${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/hailuo/image-to-video-standard.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const imageToVideoStandard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ac085327"]]);

export { imageToVideoStandard as default };
//# sourceMappingURL=image-to-video-standard-DMNR41UK.mjs.map
