...
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderClass, ssrInterpolate, ssrIncludeBooleanAttr, ssrRenderComponent, ssrRenderList, ssrRenderStyle } from 'file://C:/project/fuseaitools-web/node_modules/vue/server-renderer/index.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (currentCredits.value !== null) {
        _push(`<span style="${ssrRenderStyle({ "margin-left": "8px", "font-weight": "500" })}" data-v-821fabec> \xB7 ${ssrInterpolate(currentCredits.value)} credits`);
      ...
      if (isGenerating.value) {
        ...
        if (currentCredits.value !== null) {
          _push(`<span data-v-821fabec>\xB7 ${ssrInterpolate(currentCredits.value)} credits`);
          if (discountText.value) {
            _push(`<span data-v-821fabec>${ssrInterpolate(discountText.value)}</span>`);
          } else {
            _push(`<!---->`);
...
//# sourceMappingURL=GPTImageTool-Kipx2jty.mjs.map
