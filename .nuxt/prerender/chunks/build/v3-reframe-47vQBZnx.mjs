...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      ...
      description: "Reframe images with new aspect ratio and composition using Ideogram V3. Pay per image with credits.",
      category: "image",
      route: "/home/ideogram/v3-reframe",
      keywords: ["Ideogram", "V3", "Reframe", "AI image reframe", "aspect ratio"],
      applicationCategory: "MultimediaApplication",
      applicationSubCategory: "Image Generation",
      offers: { price: "0", priceCurrency: "USD" },
      offerDescription: "Pay per image with credits.",
      priceFromApi: { modelKey: "ideogram-v3-reframe", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-e5c4b760${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/ideogram/v3-reframe.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const v3Reframe = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e5c4b760"]]);

export { v3Reframe as default };
//# sourceMappingURL=v3-reframe-47vQBZnx.mjs.map
