...
const _sfc_main = {
  __name: "flux-2-image-to-image",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      name: "Flux 2 Image to Image Generator",
      description: "Edit and transform images with Flux 2 image-to-image using 1-8 reference images.",
      category: "image",
      route: "/home/flux-kontext/flux-2-image-to-image",
      keywords: ["Flux 2", "Image to Image", "AI image edit", "Flux Kontext"],
      applicationCategory: "MultimediaApplication",
      applicationSubCategory: "Image Generation",
      offers: { price: "0", priceCurrency: "USD" },
      offerDescription: "Pay per image with credits.",
      priceFromApi: { modelKey: "flux-2-image-to-image", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-324496ef${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/flux-kontext/flux-2-image-to-image.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const flux2ImageToImage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-324496ef"]]);

export { flux2ImageToImage as default };
//# sourceMappingURL=flux-2-image-to-image-CeJLThJj.mjs.map
