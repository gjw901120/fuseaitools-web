...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      name: "Kling 3.0 Video Generator",
      description: "Generate single-shot or multi-shot AI videos with Kling 3.0. Pay per video with credits.",
      category: "video",
      route: "/home/kling/v3-0-video",
      keywords: ["Kling", "Kuaishou", "3.0", "AI video", "multi-shot"],
      applicationCategory: "MultimediaApplication",
      applicationSubCategory: "Video Generation",
      offers: { price: "0", priceCurrency: "USD" },
      offerDescription: "Pay per video with credits.",
      priceFromApi: { modelKey: "kling-3.0-video", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-788e5318${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/kling/v3-0-video.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const v30Video = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-788e5318"]]);

export { v30Video as default };
//# sourceMappingURL=v3-0-video-BEL644Sl.mjs.map
