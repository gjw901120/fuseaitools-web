    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-ba6a5617${_scopeId}>`);
...
const imagine = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ba6a5617"]]);

export { imagine as default };
//# sourceMappingURL=imagine-CgchNNba.mjs.map
