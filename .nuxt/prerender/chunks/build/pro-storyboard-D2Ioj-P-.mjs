    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-5ea3b74f${_scopeId}>`);
            _push2(ssrRenderComponent(_component_ClientOnly, null, {
              fallback: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div style="${ssrRenderStyle({ "padding": "20px", "text-align": "center" })}" data-v-5ea3b74f${_scopeId2}>Loading Sora Tool...</div>`);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/sora/pro-storyboard.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const proStoryboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5ea3b74f"]]);

export { proStoryboard as default };
//# sourceMappingURL=pro-storyboard-D2Ioj-P-.mjs.map
