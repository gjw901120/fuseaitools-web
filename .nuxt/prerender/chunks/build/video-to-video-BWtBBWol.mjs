...
const _sfc_main = {
  ...
  setup(__props) {
    const seoConfig = useToolSEO({
      name: "Wan Video to Video",
      description: "Wan Video to Video - Transform video with new prompts. Duration 5/10s, 720p/1080p.",
      category: "video",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-9bf4b588${_scopeId}>`);
...
const videoToVideo = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9bf4b588"]]);

export { videoToVideo as default };
//# sourceMappingURL=video-to-video-BWtBBWol.mjs.map
