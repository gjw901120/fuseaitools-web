...
const _sfc_main = {
  ...
  setup(__props) {
    const seoConfig = useToolSEO({
      ...
      description: "Use Sora 2 for free online. Image-to-video AI video generation from reference images.",
      category: "video",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-c2bed0af${_scopeId}>`);
            _push2(ssrRenderComponent(_component_ClientOnly, null, {
              fallback: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div style="${ssrRenderStyle({ "padding": "20px", "text-align": "center" })}" data-v-c2bed0af${_scopeId2}>Loading Sora Tool...</div>`);
                } else {
                  return [
...
const imageToVideo = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c2bed0af"]]);

export { imageToVideo as default };
//# sourceMappingURL=image-to-video-DX8hvhoS.mjs.map
