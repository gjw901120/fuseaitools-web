...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      ...
      description: "Edit character images with mask and prompt using Ideogram. Pay per image with credits.",
      category: "image",
      route: "/home/ideogram/character-edit",
      keywords: ["Ideogram", "Character Edit", "AI character editing", "mask"],
      applicationCategory: "MultimediaApplication",
      applicationSubCategory: "Image Generation",
      offers: { price: "0", priceCurrency: "USD" },
      offerDescription: "Pay per image with credits.",
      priceFromApi: { modelKey: "ideogram-character-edit", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-d4a9422a${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/ideogram/character-edit.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const characterEdit = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d4a9422a"]]);

export { characterEdit as default };
//# sourceMappingURL=character-edit-CYW_MN3f.mjs.map
