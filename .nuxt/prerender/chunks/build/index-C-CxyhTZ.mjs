...
import { V as Veo3Tool } from './Veo3Tool-DW-3cgLa.mjs';
import { R as RunwayTool } from './RunwayTool-X9ITY_0i.mjs';
import { L as LumaTool } from './LumaTool-C5zMkBAa.mjs';
import { M as MidjourneyTool } from './MidjourneyTool-CPwhNaBr.mjs';
import { G as GPT4oImageTool } from './GPT4oImageTool-FgiKCLOE.mjs';
import { G as GPTImageTool } from './GPTImageTool-CT_Ir96o.mjs';
import { I as IdeogramTool } from './IdeogramTool-_96Q5GiO.mjs';
import { N as NanoBananaTool } from './NanoBananaTool-BxxQtb_0.mjs';
import { E as ElevenLabsTool } from './ElevenLabsTool-BKs2f907.mjs';
import { F as FluxKontextTool } from './FluxKontextTool-D710zToC.mjs';
import { S as SunoTool } from './SunoTool-BDchhMzS.mjs';
import { S as SoraTool } from './SoraTool-Bxx1aeuf.mjs';
import { W as WanTool } from './WanTool-D9OMkrdx.mjs';
import { S as SeedanceTool } from './SeedanceTool-wZptg8mB.mjs';
import { H as HailuoTool } from './HailuoTool-CATUjl1M.mjs';
import { K as KlingTool } from './KlingTool-CN4Umoxm.mjs';
import { S as SeedreamTool } from './SeedreamTool-DIEc3Bu3.mjs';
import { Q as QwenTool } from './QwenTool-CgS96IMa.mjs';
...
import './UploadAudio-BiE3XXaz.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "home-page" }, _attrs))} data-v-9c30ac1a><div class="main-layout" data-v-9c30ac1a><aside class="left-sidebar" data-v-9c30ac1a><div class="timeline-header" data-v-9c30ac1a><h3 data-v-9c30ac1a>History</h3></div><div class="timeline-container" data-v-9c30ac1a><div class="timeline-items" data-v-9c30ac1a><!--[-->`);
      ssrRenderList(unref(usageHistory), (record, index2) => {
        _push(`<div class="timeline-item" data-v-9c30ac1a><div class="${ssrRenderClass([[record.status, record.type], "timeline-marker"])}" data-v-9c30ac1a><i class="${ssrRenderClass(record.icon)}" data-v-9c30ac1a></i></div><div class="timeline-content" data-v-9c30ac1a><div class="timeline-header" data-v-9c30ac1a><div class="timeline-tool" data-v-9c30ac1a>${ssrInterpolate(record.toolName)}</div></div><div class="timeline-description" data-v-9c30ac1a>${ssrInterpolate(record.description)}</div><div class="timeline-meta" data-v-9c30ac1a><div class="timeline-time" data-v-9c30ac1a>${ssrInterpolate(formatTime(record.timestamp))}</div><div class="timeline-duration" data-v-9c30ac1a>${ssrInterpolate(record.duration)}</div></div></div></div>`);
      });
      _push(`<!--]--></div>`);
      if (unref(hasMoreData)) {
        _push(`<div class="load-more-container" data-v-9c30ac1a><button class="load-more-btn"${ssrIncludeBooleanAttr(unref(isLoading)) ? " disabled" : ""} data-v-9c30ac1a>`);
        if (unref(isLoading)) {
          _push(`<i class="fas fa-spinner fa-spin" data-v-9c30ac1a></i>`);
        } else {
          _push(`<i class="fas fa-plus" data-v-9c30ac1a></i>`);
        }
      ...
      if (unref(usageHistory).length === 0) {
        _push(`<div class="empty-timeline" data-v-9c30ac1a><i class="fas fa-history" data-v-9c30ac1a></i><p data-v-9c30ac1a>\u6682\u65E0\u4F7F\u7528\u8BB0\u5F55</p></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></aside><main class="right-main" data-v-9c30ac1a><header class="tools-navigation" data-v-9c30ac1a><div class="nav-tabs" data-v-9c30ac1a><!--[-->`);
      ssrRenderList(unref(navItems), (navItem) => {
        _push(`<div class="${ssrRenderClass([{ active: unref(selectedCategory) === navItem.id }, "nav-tab"])}" data-v-9c30ac1a><i class="${ssrRenderClass(navItem.icon)}" data-v-9c30ac1a></i><span data-v-9c30ac1a>${ssrInterpolate(navItem.name)}</span><span class="tool-count" data-v-9c30ac1a>${ssrInterpolate(getToolCount(navItem.type))}</span></div>`);
      });
      _push(`<!--]--></div>`);
      if (unref(selectedCategory)) {
        _push(`<div class="sub-nav" data-v-9c30ac1a><!--[-->`);
        ssrRenderList(getCurrentTools(), (subTool) => {
          ...
          if (toolRouteMap[subTool.name]) {
            ...
            _push(`<div class="${ssrRenderClass([{ active: unref(selectedTool) === subTool.id }, "sub-nav-item"])}" data-v-9c30ac1a>${ssrInterpolate(subTool.name)}</div>`);
          }
          _push(`<!--]-->`);
        });
        _push(`<!--]--></div>`);
      ...
      _push(`</header><section class="tool-interface" data-v-9c30ac1a>`);
      if (getSelectedToolInfo().name === "Veo3") {
        ...
        _push(`<div class="chat-interface" data-v-9c30ac1a><div class="chat-header" data-v-9c30ac1a><div class="chat-tool-info" data-v-9c30ac1a><div class="tool-avatar" data-v-9c30ac1a><img${ssrRenderAttr("src", getSelectedToolInfo().icon)}${ssrRenderAttr("alt", getSelectedToolInfo().name)} data-v-9c30ac1a></div><div class="tool-details" data-v-9c30ac1a><h3 data-v-9c30ac1a>${ssrInterpolate(getSelectedToolInfo().name)}</h3><p data-v-9c30ac1a>${ssrInterpolate(getSelectedToolInfo().description)}</p></div></div></div><div class="chat-messages" data-v-9c30ac1a><!--[-->`);
        ssrRenderList(unref(chatMessages), (message) => {
          _push(`<div class="${ssrRenderClass([message.role, "message"])}" data-v-9c30ac1a><div class="message-avatar" data-v-9c30ac1a>`);
          if (message.role === "user") {
            _push(`<img src="https://via.placeholder.com/32x32/667eea/ffffff?text=U" alt="User" data-v-9c30ac1a>`);
          } else {
            _push(`<img${ssrRenderAttr("src", getSelectedToolInfo().icon)}${ssrRenderAttr("alt", getSelectedToolInfo().name)} data-v-9c30ac1a>`);
          }
          _push(`</div><div class="message-content" data-v-9c30ac1a><div class="message-text" data-v-9c30ac1a>${ssrInterpolate(message.text)}</div><div class="message-time" data-v-9c30ac1a>${ssrInterpolate(formatTime(message.timestamp))}</div></div></div>`);
        });
        _push(`<!--]--></div><div class="chat-input" data-v-9c30ac1a>`);
        if (isChatTool()) {
          _push(`<div class="input-actions" data-v-9c30ac1a><button class="action-btn" title="Upload File" data-v-9c30ac1a><i class="fas fa-paperclip" data-v-9c30ac1a></i></button><button class="${ssrRenderClass([{ active: unref(isWebSearchEnabled) }, "action-btn"])}" title="Web Search" data-v-9c30ac1a><i class="fas fa-globe" data-v-9c30ac1a></i></button>`);
          if (unref(uploadedFiles).length > 0) {
            _push(`<div class="uploaded-files" data-v-9c30ac1a><!--[-->`);
            ssrRenderList(unref(uploadedFiles), (file, index2) => {
              _push(`<div class="file-item" data-v-9c30ac1a><span class="file-name" data-v-9c30ac1a>${ssrInterpolate(file.name)}</span><button class="file-delete-btn" title="Delete File" data-v-9c30ac1a><i class="fas fa-times" data-v-9c30ac1a></i></button></div>`);
            });
            _push(`<!--]--></div>`);
          } else {
            _push(`<!---->`);
        ...
        _push(`<div class="input-container" data-v-9c30ac1a><textarea placeholder="Enter your question or request..." rows="3" data-v-9c30ac1a>${ssrInterpolate(unref(inputMessage))}</textarea><button class="send-btn"${ssrIncludeBooleanAttr(!unref(inputMessage).trim()) ? " disabled" : ""} data-v-9c30ac1a><i class="fas fa-paper-plane" data-v-9c30ac1a></i></button></div></div></div>`);
      }
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9c30ac1a"]]);

export { index as default };
//# sourceMappingURL=index-C-CxyhTZ.mjs.map
