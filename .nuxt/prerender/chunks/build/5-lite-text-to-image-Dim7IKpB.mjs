    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-b3da08a4${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/seedream/5-lite-text-to-image.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _5LiteTextToImage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b3da08a4"]]);

export { _5LiteTextToImage as default };
//# sourceMappingURL=5-lite-text-to-image-Dim7IKpB.mjs.map
