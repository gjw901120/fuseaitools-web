...
const _sfc_main = {
  ...
  setup(__props) {
    const seoConfig = useToolSEO({
      name: "GPT Image",
      description: "GPT Image is OpenAI's flagship image generation model for high-quality image creation and precise image editing, with strong instruction following and improved text rendering. Use text-to-image or image-to-image on FuseAITools.",
      category: "image",
      route: "/home/gpt-image/generate",
      keywords: ["GPT Image", "OpenAI", "image generation", "text-to-image", "image-to-image", "AI image", "image editing"],
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-bbf16466${_scopeId}>`);
...
const generate = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-bbf16466"]]);

export { generate as default };
//# sourceMappingURL=generate-CAp511JN.mjs.map
