...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      name: "Seedance v1 Pro Text to Video Generator",
      description: "Pro text-to-video with Seedance v1. Pay per video with credits.",
      category: "video",
      ...
      priceFromApi: { modelKey: "seedance-v1-pro-text-to-video", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-e827cccc${_scopeId}>`);
...
const v1ProTextToVideo = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e827cccc"]]);

export { v1ProTextToVideo as default };
//# sourceMappingURL=v1-pro-text-to-video-DSR36qqO.mjs.map
