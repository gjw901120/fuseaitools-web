...
import { _ as __nuxt_component_0$2 } from './client-only-BJZIIy-4.mjs';
import { _ as __nuxt_component_0$3 } from './nuxt-link-BgkIFP7n.mjs';
import { mergeProps, computed, ref, withCtx, createVNode, createTextVNode, unref, watch, nextTick, useSSRContext } from 'file://C:/project/fuseaitools-web/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSlot, ssrRenderAttr, ssrRenderList, ssrRenderTeleport, ssrIncludeBooleanAttr, ssrInterpolate, ssrRenderClass } from 'file://C:/project/fuseaitools-web/node_modules/vue/server-renderer/index.mjs';
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        if (__props.isOpen) {
          _push2(`<div class="modal-overlay" data-v-1c0da832><div class="modal-content" data-v-1c0da832><button class="close-btn" data-v-1c0da832><i class="fas fa-times" data-v-1c0da832></i></button><div class="modal-header" data-v-1c0da832><h2 class="modal-title" data-v-1c0da832>Welcome</h2><p class="modal-subtitle" data-v-1c0da832>Sign in or sign up to continue</p></div><div class="login-options" data-v-1c0da832><button class="login-btn google-btn" data-v-1c0da832><div class="btn-content" data-v-1c0da832><svg class="google-icon" viewBox="0 0 24 24" width="20" height="20" data-v-1c0da832><path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" data-v-1c0da832></path><path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" data-v-1c0da832></path><path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" data-v-1c0da832></path><path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" data-v-1c0da832></path></svg><span data-v-1c0da832>Continue with Google</span></div></button><div class="divider" data-v-1c0da832><span class="divider-text" data-v-1c0da832>OR</span></div><div class="email-login" data-v-1c0da832><input${ssrRenderAttr("value", unref(email))} type="email" class="email-input" placeholder="Enter your email" data-v-1c0da832><button class="login-btn continue-btn"${ssrIncludeBooleanAttr(unref(loading)) ? " disabled" : ""} data-v-1c0da832>`);
          if (unref(loading)) {
            _push2(`<span data-v-1c0da832>Sending...</span>`);
          } else {
            _push2(`<span data-v-1c0da832>Continue</span>`);
          }
          _push2(`</button>`);
          if (unref(error)) {
            _push2(`<p class="error-message" data-v-1c0da832>${ssrInterpolate(unref(error))}</p>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div></div><div class="modal-footer" data-v-1c0da832><p class="footer-text" data-v-1c0da832> By signing up, you agree to the <a href="#" class="footer-link" data-v-1c0da832>Terms of Service</a> and <a href="#" class="footer-link" data-v-1c0da832>Privacy Policy</a>. </p></div></div></div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
...
const __nuxt_component_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-1c0da832"]]);
const _sfc_main$5 = {
...
const _imports_0 = "" + buildAssetsURL("favicon.Dk0XY8J4.ico");
const _sfc_main$4 = {
  __name: "AppHeader",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "app-header" }, _attrs))} data-v-2bc95c41>`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
      _push(`<div class="simply-container" data-v-2bc95c41><div class="header-content" data-v-2bc95c41><div class="logo" data-v-2bc95c41>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} alt="Fuse AI" class="logo-icon" data-v-2bc95c41${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
      ...
      _push(`</div><nav class="nav" data-v-2bc95c41>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/home",
        class: "nav-link"
      }, {
      ...
      _push(`</nav><div class="header-actions" data-v-2bc95c41>`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {
        fallback: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="btn-signup" disabled data-v-2bc95c41${_scopeId}>Loading...</button>`);
          } else {
            return [
              createVNode("button", {
                class: "btn-signup",
      ...
      _push(`</div><button class="mobile-menu-btn" data-v-2bc95c41><i class="fas fa-bars" data-v-2bc95c41></i></button></div>`);
      if (unref(mobileMenuOpen)) {
        _push(`<div class="mobile-menu" data-v-2bc95c41>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/home",
        ...
        _push(`<div class="mobile-actions" data-v-2bc95c41>`);
        _push(ssrRenderComponent(_component_ClientOnly, null, {
          fallback: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<button class="btn-signup" disabled data-v-2bc95c41${_scopeId}>Loading...</button>`);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(isVisible)) {
        ...
        if (__props.type === "error") {
          _push(`<span class="toast-emoji" data-v-7f20bd99>\u{1F614}</span>`);
...
//# sourceMappingURL=default-CtfT8DyB.mjs.map
