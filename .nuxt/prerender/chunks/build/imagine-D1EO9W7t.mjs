    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-10440b4a${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/midjourney/imagine.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const imagine = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-10440b4a"]]);

export { imagine as default };
//# sourceMappingURL=imagine-D1EO9W7t.mjs.map
