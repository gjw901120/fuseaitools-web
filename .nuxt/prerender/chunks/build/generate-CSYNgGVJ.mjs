...
const _sfc_main = {
  ...
  setup(__props) {
    const seoConfig = useToolSEO({
      ...
      description: "Create new music with Suno AI. Generate complete music from scratch. Use for free online.",
      category: "audio",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-e823b90f${_scopeId}>`);
...
const generate = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e823b90f"]]);

export { generate as default };
//# sourceMappingURL=generate-CSYNgGVJ.mjs.map
