...
const _sfc_main = {
  ...
  setup(__props) {
    const seoConfig = useToolSEO({
      ...
      description: "Kling 2.6 Image to Video - Image-to-video with sound, duration 5/10s.",
      category: "video",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-c3a35a41${_scopeId}>`);
...
const v26ImageToVideo = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c3a35a41"]]);

export { v26ImageToVideo as default };
//# sourceMappingURL=v2-6-image-to-video-DQHkSKJ0.mjs.map
