...
import { I as IdeogramTool } from './IdeogramTool-DuhEQ7ad.mjs';
...
const _sfc_main = {
  __name: "v3-text-to-image",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      name: "Ideogram V3 Text to Image Generator",
      description: "Generate images from text with Ideogram V3. Pay per image with credits.",
      category: "image",
      route: "/home/ideogram/v3-text-to-image",
      keywords: ["Ideogram", "V3", "Text to Image", "AI image generation"],
      applicationCategory: "MultimediaApplication",
      applicationSubCategory: "Image Generation",
      offers: { price: "0", priceCurrency: "USD" },
      offerDescription: "Pay per image with credits.",
      priceFromApi: { modelKey: "ideogram-v3-text-to-image", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-970be5ba${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/ideogram/v3-text-to-image.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const v3TextToImage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-970be5ba"]]);

export { v3TextToImage as default };
//# sourceMappingURL=v3-text-to-image-B62dhslI.mjs.map
