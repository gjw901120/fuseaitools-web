...
const _sfc_main = {
  ...
  setup(__props) {
    const seoConfig = useToolSEO({
      ...
      description: "Hailuo Pro - MiniMax high-fidelity AI image-to-video. Realistic motion, expressive characters, cinematic visuals. 6s/10s, 768P/1080P.",
      category: "video",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-f76cf04f${_scopeId}>`);
...
const imageToVideoPro = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f76cf04f"]]);

export { imageToVideoPro as default };
//# sourceMappingURL=image-to-video-pro-BO8pfYCq.mjs.map
