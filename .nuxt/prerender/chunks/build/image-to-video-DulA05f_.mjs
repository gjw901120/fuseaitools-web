...
const _sfc_main = {
  ...
  setup(__props) {
    const seoConfig = useToolSEO({
      ...
      description: "Wan Image to Video - Animate images with text prompts. Min 256\xD7256px, duration 5/10/15s, 720p/1080p.",
      category: "video",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-df0758a5${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/wan/image-to-video.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const imageToVideo = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-df0758a5"]]);

export { imageToVideo as default };
//# sourceMappingURL=image-to-video-DulA05f_.mjs.map
