...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      name: "Luma 3D Video Generator",
      description: "Create 3D AI video from text or images with Luma. Pay per video with credits.",
      category: "video",
      ...
      priceFromApi: { modelKey: "Luma", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-9b65543b${_scopeId}>`);
...
const generate = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9b65543b"]]);

export { generate as default };
//# sourceMappingURL=generate-HcIJJNHl.mjs.map
