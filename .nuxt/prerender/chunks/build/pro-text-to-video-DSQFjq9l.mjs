...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      name: "Sora Pro Text to Video Generator",
      description: "High-quality text-to-video with Sora 2 Pro. Pay per video with credits.",
      category: "video",
      ...
      priceFromApi: { modelKey: "sora-2-pro-text-to-video", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-fb76618b${_scopeId}>`);
            _push2(ssrRenderComponent(_component_ClientOnly, null, {
              fallback: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div style="${ssrRenderStyle({ "padding": "20px", "text-align": "center" })}" data-v-fb76618b${_scopeId2}>Loading Sora Tool...</div>`);
                } else {
                  return [
...
const proTextToVideo = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fb76618b"]]);

export { proTextToVideo as default };
//# sourceMappingURL=pro-text-to-video-DSQFjq9l.mjs.map
