...
import { ssrRenderAttrs, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderStyle } from 'file://C:/project/fuseaitools-web/node_modules/vue/server-renderer/index.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(faqs), (faq, index) => {
        var _a;
        _push(`<div class="faq-item" data-v-b4dfa639><button class="faq-question" data-v-b4dfa639>${ssrInterpolate(faq.question)} <i class="${ssrRenderClass([{ rotated: faq.isOpen }, "fas fa-chevron-down"])}" data-v-b4dfa639></i></button><div class="${ssrRenderClass([{ open: faq.isOpen }, "faq-answer"])}" data-v-b4dfa639><div class="faq-content" data-v-b4dfa639>${(_a = faq.answer) != null ? _a : ""}</div></div></div>`);
      });
...
//# sourceMappingURL=pricing-BASf1fBj.mjs.map
