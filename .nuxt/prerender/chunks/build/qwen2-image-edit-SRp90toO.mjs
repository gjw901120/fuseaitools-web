...
const _sfc_main = {
  __name: "qwen2-image-edit",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      name: "Qwen2 Image Edit",
      description: "Edit images with qwen2/image-edit model. Pay per image with credits.",
      category: "image",
      route: "/home/qwen/qwen2-image-edit",
      keywords: ["Qwen2", "Image Edit", "AI image"],
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-84c34e4a${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/qwen/qwen2-image-edit.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const qwen2ImageEdit = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-84c34e4a"]]);

export { qwen2ImageEdit as default };
//# sourceMappingURL=qwen2-image-edit-SRp90toO.mjs.map
