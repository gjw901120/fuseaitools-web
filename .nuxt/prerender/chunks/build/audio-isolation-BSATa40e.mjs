    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-cfae6927${_scopeId}>`);
...
const audioIsolation = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cfae6927"]]);

export { audioIsolation as default };
//# sourceMappingURL=audio-isolation-BSATa40e.mjs.map
