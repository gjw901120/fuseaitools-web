...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      name: "Imagen4 Fast",
      description: "Fast Imagen4 image generation with prompt, negative prompt, aspect ratio, multi-image count, and seed.",
      category: "image",
      route: "/home/imagen4/imagen4-fast",
      keywords: ["Imagen4 Fast", "AI image", "text to image"],
      applicationCategory: "MultimediaApplication",
      applicationSubCategory: "Image Generation",
      offers: { price: "0", priceCurrency: "USD" },
      offerDescription: "Pay per image with credits.",
      priceFromApi: { modelKey: "imagen4-fast", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-6cdd4c71${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/imagen4/imagen4-fast.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const imagen4Fast = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6cdd4c71"]]);

export { imagen4Fast as default };
//# sourceMappingURL=imagen4-fast-aC1JHrUc.mjs.map
