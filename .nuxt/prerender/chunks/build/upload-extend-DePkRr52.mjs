    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-c1de8cf6${_scopeId}>`);
...
const uploadExtend = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c1de8cf6"]]);

export { uploadExtend as default };
//# sourceMappingURL=upload-extend-DePkRr52.mjs.map
