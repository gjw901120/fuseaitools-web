...
const _sfc_main = {
  ...
  setup(__props) {
    const seoConfig = useToolSEO({
      ...
      description: "Kling 2.6 Motion Control - Reference image + reference video, character orientation, 720p/1080p.",
      category: "video",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-1cc3a262${_scopeId}>`);
...
const v26MotionControl = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1cc3a262"]]);

export { v26MotionControl as default };
//# sourceMappingURL=v2-6-motion-control-DOXWo5DF.mjs.map
