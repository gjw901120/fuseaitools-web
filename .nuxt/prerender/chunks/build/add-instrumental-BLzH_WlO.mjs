...
const _sfc_main = {
  ...
  setup(__props) {
    const seoConfig = useToolSEO({
      ...
      description: "Generate accompaniment with Suno AI. Use for free online.",
      category: "audio",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-f82bc992${_scopeId}>`);
...
const addInstrumental = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f82bc992"]]);

export { addInstrumental as default };
//# sourceMappingURL=add-instrumental-BLzH_WlO.mjs.map
