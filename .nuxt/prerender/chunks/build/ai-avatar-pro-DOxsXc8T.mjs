...
const _sfc_main = {
  ...
  setup(__props) {
    const seoConfig = useToolSEO({
      ...
      description: "Kling AI Avatar Pro - High-quality avatar image + audio to talking-head video. Prompt max 5000 characters.",
      category: "video",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-0b263e7b${_scopeId}>`);
...
const aiAvatarPro = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0b263e7b"]]);

export { aiAvatarPro as default };
//# sourceMappingURL=ai-avatar-pro-DOxsXc8T.mjs.map
