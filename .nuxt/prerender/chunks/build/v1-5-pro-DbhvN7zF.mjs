...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      name: "Seedance 1.5 Pro Video Generator",
      description: "Generate videos with Seedance 1.5 Pro using text prompts or optional image references. Supports 4/8/12s, 480p/720p/1080p, fixed lens, and audio generation.",
      category: "video",
      route: "/home/seedance/v1-5-pro",
      keywords: ["Seedance", "1.5 Pro", "Text to Video", "Image to Video", "AI video"],
      applicationCategory: "MultimediaApplication",
      applicationSubCategory: "Video Generation",
      offers: { price: "0", priceCurrency: "USD" },
      offerDescription: "Pay per video with credits.",
      priceFromApi: { modelKey: "seedance-1.5-pro", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-5a901acf${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/seedance/v1-5-pro.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const v15Pro = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5a901acf"]]);

export { v15Pro as default };
//# sourceMappingURL=v1-5-pro-DbhvN7zF.mjs.map
