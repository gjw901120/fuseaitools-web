    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-ccdb0d4c${_scopeId}>`);
...
const imageToVideoStandard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ccdb0d4c"]]);

export { imageToVideoStandard as default };
//# sourceMappingURL=image-to-video-standard-0XQmE3Ek.mjs.map
