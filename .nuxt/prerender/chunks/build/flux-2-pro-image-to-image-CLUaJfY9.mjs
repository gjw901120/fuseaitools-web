...
const _sfc_main = {
  __name: "flux-2-pro-image-to-image",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      name: "Flux 2 Pro Image to Image Generator",
      description: "Generate and edit images with Flux 2 Pro image-to-image from 1-8 inputs.",
      category: "image",
      route: "/home/flux-kontext/flux-2-pro-image-to-image",
      keywords: ["Flux 2 Pro", "Image to Image", "AI image edit", "Flux Kontext"],
      applicationCategory: "MultimediaApplication",
      applicationSubCategory: "Image Generation",
      offers: { price: "0", priceCurrency: "USD" },
      offerDescription: "Pay per image with credits.",
      priceFromApi: { modelKey: "flux-2-pro-image-to-image", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-50380fd7${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/flux-kontext/flux-2-pro-image-to-image.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const flux2ProImageToImage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-50380fd7"]]);

export { flux2ProImageToImage as default };
//# sourceMappingURL=flux-2-pro-image-to-image-CLUaJfY9.mjs.map
