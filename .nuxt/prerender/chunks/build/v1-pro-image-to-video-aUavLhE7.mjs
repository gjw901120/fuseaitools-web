...
const _sfc_main = {
  __name: "v1-pro-image-to-video",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      name: "Seedance v1 Pro Image to Video Generator",
      description: "Pro image-to-video with Seedance v1. Pay per video with credits.",
      category: "video",
      route: "/home/seedance/v1-pro-image-to-video",
      keywords: ["Seedance", "Pro Image to Video", "AI video", "v1-pro"],
      applicationCategory: "MultimediaApplication",
      applicationSubCategory: "Video Generation",
      offers: { price: "0", priceCurrency: "USD" },
      offerDescription: "Pay per video with credits.",
      priceFromApi: { modelKey: "seedance-v1-pro-image-to-video", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-627d2b62${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/seedance/v1-pro-image-to-video.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const v1ProImageToVideo = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-627d2b62"]]);

export { v1ProImageToVideo as default };
//# sourceMappingURL=v1-pro-image-to-video-aUavLhE7.mjs.map
