  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(faqItems.value, (item, index2) => {
        ...
        if (item.isOpen) {
          _push(`<div class="faq-answer" data-v-bb839d82><div class="faq-content" data-v-bb839d82>${(_a = item.answer) != null ? _a : ""}</div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</article>`);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "homepage" }, _attrs))} data-v-52372b5f>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-52372b5f"]]);

export { index as default };
//# sourceMappingURL=index-D1mKv57v.mjs.map
