...
const _sfc_main = {
  ...
  setup(__props) {
    const seoConfig = useToolSEO({
      ...
      description: "Seedance v1 Pro Image to Video - Pro image-to-video with 480p/720p/1080p, 5s/10s, seed, safety checker.",
      category: "video",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-be75c65c${_scopeId}>`);
...
const v1ProImageToVideo = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-be75c65c"]]);

export { v1ProImageToVideo as default };
//# sourceMappingURL=v1-pro-image-to-video-VIC9CYkv.mjs.map
