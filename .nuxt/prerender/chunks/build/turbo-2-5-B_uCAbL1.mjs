    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-b9cfa13e${_scopeId}>`);
...
const turbo25 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b9cfa13e"]]);

export { turbo25 as default };
//# sourceMappingURL=turbo-2-5-B_uCAbL1.mjs.map
