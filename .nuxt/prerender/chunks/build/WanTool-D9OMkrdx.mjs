    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (mode.value === "video-to-video") {
        ...
        if (isUploadingVideo.value) {
          ...
          _push(`<div class="wan-video-preview-wrap" data-v-2dbc3e7c><video${ssrRenderAttr("src", formData.videoUrls[0])} class="wan-video-preview" controls data-v-2dbc3e7c></video><button type="button" class="wan-video-remove" title="Remove" data-v-2dbc3e7c>\xD7</button></div>`);
        } else {
...
export { WanTool as W };
//# sourceMappingURL=WanTool-D9OMkrdx.mjs.map
