...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => navigateTo("/home/ideogram/v3-text-to-image", { replace: true, redirectCode: 301 })), await __temp, __restore();
...
//# sourceMappingURL=generate-DHYjYhGa.mjs.map
