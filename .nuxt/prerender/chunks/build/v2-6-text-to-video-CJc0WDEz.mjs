...
const _sfc_main = {
  ...
  setup(__props) {
    const seoConfig = useToolSEO({
      ...
      description: "Kling 2.6 Text to Video - Text-to-video with sound, aspect ratio 1:1/16:9/9:16, duration 5/10s.",
      category: "video",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-3f2edba5${_scopeId}>`);
...
const v26TextToVideo = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3f2edba5"]]);

export { v26TextToVideo as default };
//# sourceMappingURL=v2-6-text-to-video-CJc0WDEz.mjs.map
