...
const _sfc_main = {
  ...
  setup(__props) {
    const seoConfig = useToolSEO({
      ...
      description: "Kling 3.0 Video - Single shot or multi-shot, image refs, elements, duration 3-15s, sound.",
      category: "video",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-8b52b3f7${_scopeId}>`);
...
const v30Video = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8b52b3f7"]]);

export { v30Video as default };
//# sourceMappingURL=v3-0-video-D1CCQx9V.mjs.map
