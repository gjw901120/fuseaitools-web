import { _ as __nuxt_component_0$1 } from './HomeLayout-DmP_sp7g.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-overview content-padding" data-v-925d45e4${_scopeId}><header class="overview-header" data-v-925d45e4${_scopeId}>`);
            if (__props.config.showCategory !== false) {
              _push2(`<span class="overview-category" data-v-925d45e4${_scopeId}>${ssrInterpolate(__props.config.category)}</span>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<div class="overview-title-row" data-v-925d45e4${_scopeId}>`);
            if (__props.config.logo) {
              _push2(`<img${ssrRenderAttr("src", __props.config.logo)} alt="" class="overview-title-logo" data-v-925d45e4${_scopeId}>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<h1 class="overview-title" data-v-925d45e4${_scopeId}>${ssrInterpolate(__props.config.title)}</h1></div><p class="${ssrRenderClass([{ "intro-full-width": __props.config.introFullWidth }, "overview-intro"])}" data-v-925d45e4${_scopeId}>${ssrInterpolate(__props.config.intro)}</p></header><section class="overview-features" data-v-925d45e4${_scopeId}><h2 class="features-heading" data-v-925d45e4${_scopeId}><i class="fas fa-th-large features-heading-icon" data-v-925d45e4${_scopeId}></i> Features </h2><div class="features-grid" data-v-925d45e4${_scopeId}><!--[-->`);
            ssrRenderList(__props.config.features, (feature) => {
              _push2(ssrRenderComponent(_component_NuxtLink, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="feature-card" data-v-925d45e4${_scopeId2}><div class="feature-icon" data-v-925d45e4${_scopeId2}><i class="fas fa-arrow-right" data-v-925d45e4${_scopeId2}></i></div><h3 class="feature-title" data-v-925d45e4${_scopeId2}>${ssrInterpolate(feature.name)}</h3><p class="feature-description" data-v-925d45e4${_scopeId2}>${ssrInterpolate(feature.description)}</p><span class="feature-cta" data-v-925d45e4${_scopeId2}>Use this feature \u2192</span></div>`);
                  } else {
                    return [
            ...
            if (__props.config.sections && __props.config.sections.length) {
              _push2(`<div class="sections-wrapper" data-v-925d45e4${_scopeId}><!--[-->`);
              ssrRenderList(__props.config.sections, (section, idx) => {
                _push2(`<section class="overview-section" data-v-925d45e4${_scopeId}><h2 class="section-title" data-v-925d45e4${_scopeId}>${ssrInterpolate(section.title)}</h2><div class="section-content" data-v-925d45e4${_scopeId}><!--[-->`);
                ssrRenderList(sectionParagraphs(section.content), (para, i) => {
                  _push2(`<p class="section-para" data-v-925d45e4${_scopeId}>${ssrInterpolate(para)}</p>`);
                });
                _push2(`<!--]--></div></section>`);
              });
              _push2(`<!--]--></div>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-925d45e4"]]);
const toolOverviews = {
  gpt: {
    title: "GPT",
    category: "Chat",
...
//# sourceMappingURL=useToolOverviewPage-BwceZGA1.mjs.map
