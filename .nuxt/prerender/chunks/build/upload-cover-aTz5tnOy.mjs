...
const _sfc_main = {
  ...
  setup(__props) {
    const seoConfig = useToolSEO({
      ...
      description: "Recreate audio with Suno AI. Upload cover for recreation. Use for free online.",
      category: "audio",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-d81181f4${_scopeId}>`);
...
const uploadCover = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d81181f4"]]);

export { uploadCover as default };
//# sourceMappingURL=upload-cover-aTz5tnOy.mjs.map
