...
const _sfc_main = {
  __name: "ai-avatar-pro",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      name: "Kling AI Avatar Pro",
      description: "High-quality talking-head video from avatar and audio with Kling Pro. Pay per video with credits.",
      category: "video",
      route: "/home/kling/ai-avatar-pro",
      keywords: ["Kling", "Kuaishou", "AI Avatar Pro", "talking head", "video"],
      applicationCategory: "MultimediaApplication",
      applicationSubCategory: "Video Generation",
      offers: { price: "0", priceCurrency: "USD" },
      offerDescription: "Pay per video with credits.",
      priceFromApi: { modelKey: "kling-ai-avatar-pro", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-3c602b79${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/kling/ai-avatar-pro.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const aiAvatarPro = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3c602b79"]]);

export { aiAvatarPro as default };
//# sourceMappingURL=ai-avatar-pro-DO36LJX2.mjs.map
