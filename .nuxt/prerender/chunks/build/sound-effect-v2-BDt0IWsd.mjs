    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-55e2737c${_scopeId}>`);
...
const soundEffectV2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-55e2737c"]]);

export { soundEffectV2 as default };
//# sourceMappingURL=sound-effect-v2-BDt0IWsd.mjs.map
