import { computed, ref, reactive, watch, mergeProps, useSSRContext } from 'file://C:/project/fuseaitools-web/node_modules/vue/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div></div><div class="usage-tips" data-v-0ee26246><div class="tip-item" data-v-0ee26246><span class="tip-icon" data-v-0ee26246>\u{1F3A8}</span><span data-v-0ee26246>Describe the image you want in English; the more detailed the prompt, the better the result</span></div></div></div>`);
    };
  }
};
...
//# sourceMappingURL=MidjourneyTool-DCuO5W57.mjs.map
