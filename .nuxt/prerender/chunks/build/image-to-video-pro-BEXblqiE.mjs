...
import { H as HailuoTool } from './HailuoTool-fdY1TWiN.mjs';
...
const _sfc_main = {
  __name: "image-to-video-pro",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      name: "Hailuo Pro Image to Video Generator",
      description: "High-fidelity image-to-video with Hailuo MiniMax Pro. Pay per video with credits.",
      category: "video",
      route: "/home/hailuo/image-to-video-pro",
      keywords: ["Hailuo", "MiniMax", "Image to Video", "AI video", "2.3 Pro"],
      applicationCategory: "MultimediaApplication",
      applicationSubCategory: "Video Generation",
      offers: { price: "0", priceCurrency: "USD" },
      offerDescription: "Pay per video with credits.",
      priceFromApi: { modelKey: "hailuo-2-3-image-to-video-pro", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-7de8de8e${_scopeId}>`);
            _push2(ssrRenderComponent(HailuoTool, null, null, _parent2, _scopeId));
            _push2(`</div>`);
          } else {
            return [
              createVNode("div", { class: "tool-page" }, [
                createVNode(HailuoTool)
              ])
            ];
          }
        }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/hailuo/image-to-video-pro.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const imageToVideoPro = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7de8de8e"]]);

export { imageToVideoPro as default };
//# sourceMappingURL=image-to-video-pro-BEXblqiE.mjs.map
