  ...
  setup(__props) {
    ...
    const displayResult = computed(() => {
      ...
      if (isDetailView.value && ((_a = detailData.value) == null ? void 0 : _a.status) === 2 && ((_c = (_b = detailData.value) == null ? void 0 : _b.outputUrls) == null ? void 0 : _c.length)) {
        ...
        return { ...od, audioUrl, transcript: (_a2 = detailData.value.transcript) != null ? _a2 : od.transcript };
      }
      return result.value;
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div></div><div class="usage-tips" data-v-8e424e88><div class="tip-item" data-v-8e424e88><span class="tip-icon" data-v-8e424e88>\u{1F3A4}</span><span data-v-8e424e88>Text-to-Speech: Supports multiple languages and voice styles, adjustable stability, similarity and style parameters</span></div><div class="tip-item" data-v-8e424e88><span class="tip-icon" data-v-8e424e88>\u{1F4DD}</span><span data-v-8e424e88>Speech-to-Text: High-precision speech recognition with speaker identification and audio event marking</span></div><div class="tip-item" data-v-8e424e88><span class="tip-icon" data-v-8e424e88>\u{1F3B5}</span><span data-v-8e424e88>Sound Effect Generation: AI-driven sound effect generation with loop playback and duration control</span></div><div class="tip-item" data-v-8e424e88><span class="tip-icon" data-v-8e424e88>\u2702\uFE0F</span><span data-v-8e424e88>AI Audio Isolation: Intelligently isolate vocals and background music</span></div></div></div>`);
    };
  }
};
...
//# sourceMappingURL=ElevenLabsTool-C94H40kr.mjs.map
