  ...
  setup(__props) {
    ...
    const klingPriceText = computed(() => {
      ...
      if (m === "v2-5-turbo-image-to-video-pro") {
        ...
        return str ? `\xB7 ${str} credits${discountText.value}` : "";
      }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "kling-tool" }, _attrs))} data-v-8b9b0971><div class="tool-header" data-v-8b9b0971><div class="tool-avatar" data-v-8b9b0971><img${ssrRenderAttr("src", _imports_0)} alt="Kling" data-v-8b9b0971></div><div class="tool-details" data-v-8b9b0971><h3 data-v-8b9b0971>Kling</h3><p class="tool-description" data-v-8b9b0971>Kling is the latest AI video generation model from Kuaishou Kling, designed for text-to-video and image-to-video creation. Compared to earlier versions, it features better prompt adherence, more fluid motion, consistent artistic styles, and realistic physics simulation.</p></div></div><div class="mode-tabs-wrap" data-v-8b9b0971><div class="mode-tabs" data-v-8b9b0971><!--[-->`);
      ssrRenderList(modeList, (m) => {
        _push(`<div class="${ssrRenderClass([tabClass(m.id), "mode-tab"])}" data-v-8b9b0971><i class="${ssrRenderClass(m.icon)}" data-v-8b9b0971></i><span data-v-8b9b0971>${ssrInterpolate(m.label)}</span></div>`);
      });
      _push(`<!--]--></div></div><div class="main-content" data-v-8b9b0971><div class="config-panel" data-v-8b9b0971><div class="config-header" data-v-8b9b0971><h4 data-v-8b9b0971>Configuration</h4></div><form class="config-form" data-v-8b9b0971><fieldset class="config-fieldset"${ssrIncludeBooleanAttr(isGenerating.value || isDetailView.value) ? " disabled" : ""} data-v-8b9b0971>`);
      if (showPrompt.value) {
        _push(`<div class="form-group" data-v-8b9b0971><label class="form-label" data-v-8b9b0971>Prompt <span class="required" data-v-8b9b0971>*</span></label><textarea class="form-input"${ssrRenderAttr("rows", modeAvatar.value ? 3 : 4)}${ssrRenderAttr("placeholder", promptPlaceholder.value)}${ssrRenderAttr("maxlength", promptMaxLength.value)} data-v-8b9b0971>${ssrInterpolate(formData.prompt)}</textarea>`);
        if (formData.prompt) {
          _push(`<div class="char-count" data-v-8b9b0971>${ssrInterpolate(formData.prompt.length)}/${ssrInterpolate(promptMaxLength.value)}</div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      if (mode.value === "v2-5-turbo-image-to-video-pro") {
        _push(`<div class="form-group" data-v-8b9b0971><label class="form-label" data-v-8b9b0971>Image URL <span class="required" data-v-8b9b0971>*</span></label>`);
        ...
        if (isUploadingImage.value) {
          _push(`<span class="form-hint" data-v-8b9b0971>Uploading...</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      if (mode.value === "v2-5-turbo-image-to-video-pro") {
        _push(`<div class="form-group" data-v-8b9b0971><label class="form-label" data-v-8b9b0971>Tail frame image (optional)</label>`);
        _push(ssrRenderComponent(UploadImage, {
      ...
      if (mode.value === "v2-5-turbo-image-to-video-pro" || mode.value === "v2-5-turbo-text-to-video-pro") {
        _push(`<!--[--><div class="form-group" data-v-8b9b0971><label class="form-label" data-v-8b9b0971>Duration</label><div class="tab-group" data-v-8b9b0971><button type="button" class="${ssrRenderClass([duration5Class(), "tab-option"])}" data-v-8b9b0971>5s</button><button type="button" class="${ssrRenderClass([duration10Class(), "tab-option"])}" data-v-8b9b0971>10s</button></div></div>`);
        if (mode.value === "v2-5-turbo-text-to-video-pro") {
          _push(`<div class="form-group" data-v-8b9b0971><label class="form-label" data-v-8b9b0971>Aspect ratio</label><div class="tab-group" data-v-8b9b0971><button type="button" class="${ssrRenderClass([aspectRatio16_9Class.value, "tab-option"])}" data-v-8b9b0971>16:9</button><button type="button" class="${ssrRenderClass([aspectRatio9_16Class.value, "tab-option"])}" data-v-8b9b0971>9:16</button><button type="button" class="${ssrRenderClass([aspectRatio1_1Class.value, "tab-option"])}" data-v-8b9b0971>1:1</button></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="form-group" data-v-8b9b0971><label class="form-label" data-v-8b9b0971>Negative prompt (optional)</label><textarea class="form-input" rows="2"${ssrRenderAttr("maxlength", mode.value === "v2-5-turbo-image-to-video-pro" ? 2496 : 2500)} placeholder="Elements to avoid" data-v-8b9b0971>${ssrInterpolate(formData.negative_prompt)}</textarea></div><div class="form-group" data-v-8b9b0971><label class="form-label" data-v-8b9b0971>CFG scale (0-1)</label><input${ssrRenderAttr("value", formData.cfg_scale)} type="number" min="0" max="1" step="0.1" class="form-input" data-v-8b9b0971></div><!--]-->`);
      } else {
        _push(`<!---->`);
      }
      if (mode.value === "v2-6-text-to-video") {
        _push(`<!--[--><div class="form-group" data-v-8b9b0971><label class="form-label" data-v-8b9b0971>Sound</label><div class="tab-group" data-v-8b9b0971><button type="button" class="${ssrRenderClass([soundOffClass(), "tab-option"])}" data-v-8b9b0971>Off</button><button type="button" class="${ssrRenderClass([soundOnClass(), "tab-option"])}" data-v-8b9b0971>On</button></div></div><div class="form-group" data-v-8b9b0971><label class="form-label" data-v-8b9b0971>Aspect ratio</label><div class="tab-group" data-v-8b9b0971><button type="button" class="${ssrRenderClass([aspectRatio1_1Class.value, "tab-option"])}" data-v-8b9b0971>1:1</button><button type="button" class="${ssrRenderClass([aspectRatio16_9Class.value, "tab-option"])}" data-v-8b9b0971>16:9</button><button type="button" class="${ssrRenderClass([aspectRatio9_16Class.value, "tab-option"])}" data-v-8b9b0971>9:16</button></div></div><div class="form-group" data-v-8b9b0971><label class="form-label" data-v-8b9b0971>Duration</label><div class="tab-group" data-v-8b9b0971><button type="button" class="${ssrRenderClass([duration5Class(), "tab-option"])}" data-v-8b9b0971>5s</button><button type="button" class="${ssrRenderClass([duration10Class(), "tab-option"])}" data-v-8b9b0971>10s</button></div></div><!--]-->`);
      } else {
        _push(`<!---->`);
      }
      if (mode.value === "v2-6-image-to-video") {
        _push(`<!--[--><div class="form-group" data-v-8b9b0971><label class="form-label" data-v-8b9b0971>Image URLs <span class="required" data-v-8b9b0971>*</span></label>`);
        _push(ssrRenderComponent(UploadImage, {
      ...
      if (mode.value === "v2-6-motion-control" || mode.value === "v3-0-motion-control") {
        _push(`<!--[--><div class="form-group" data-v-8b9b0971><label class="form-label" data-v-8b9b0971>Reference image <span class="required" data-v-8b9b0971>*</span></label>`);
        _push(ssrRenderComponent(UploadImage, {
        ...
        _push(`</div><div class="form-group" data-v-8b9b0971><label class="form-label" data-v-8b9b0971>Reference video <span class="required" data-v-8b9b0971>*</span></label><div class="kling-video-upload" data-v-8b9b0971><div class="${ssrRenderClass([{ "has-video": formData.video_urls.length }, "kling-video-trigger"])}" data-v-8b9b0971><input type="file" accept="video/mp4,video/quicktime,video/x-matroska" class="kling-video-file-input" data-v-8b9b0971><div class="kling-video-trigger-inner" data-v-8b9b0971><i class="fas fa-cloud-upload-alt" data-v-8b9b0971></i><span data-v-8b9b0971>Click to upload video</span><small data-v-8b9b0971>Supports MP4/MOV/MKV, max 100MB</small></div></div>`);
        if (isUploadingMotionVideo.value) {
          _push(`<div class="kling-video-uploading" data-v-8b9b0971><i class="fas fa-spinner fa-spin" data-v-8b9b0971></i> Uploading video... </div>`);
        } else {
          _push(`<!---->`);
        }
        if (formData.video_urls.length && !isUploadingMotionVideo.value) {
          _push(`<div class="kling-video-display" data-v-8b9b0971><div class="kling-video-preview-wrap" data-v-8b9b0971><video${ssrRenderAttr("src", formData.video_urls[0])} class="kling-video-preview" controls data-v-8b9b0971></video></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div><div class="form-group" data-v-8b9b0971><label class="form-label" data-v-8b9b0971>Character orientation</label><div class="tab-group" data-v-8b9b0971><button type="button" class="${ssrRenderClass([orientationImageClass(), "tab-option"])}" data-v-8b9b0971>Image</button><button type="button" class="${ssrRenderClass([orientationVideoClass(), "tab-option"])}" data-v-8b9b0971>Video</button></div></div><div class="form-group" data-v-8b9b0971><label class="form-label" data-v-8b9b0971>${ssrInterpolate(mode.value === "v3-0-motion-control" ? "Quality mode" : "Resolution")}</label><div class="tab-group" data-v-8b9b0971>`);
        if (mode.value === "v3-0-motion-control") {
          _push(`<!--[--><button type="button" class="${ssrRenderClass([{ active: formData.mode === "std" }, "tab-option"])}" data-v-8b9b0971>std</button><button type="button" class="${ssrRenderClass([{ active: formData.mode === "pro" }, "tab-option"])}" data-v-8b9b0971>pro</button><!--]-->`);
        } else {
          _push(`<!--[--><button type="button" class="${ssrRenderClass([mode720Class(), "tab-option"])}" data-v-8b9b0971>720p</button><button type="button" class="${ssrRenderClass([mode1080Class(), "tab-option"])}" data-v-8b9b0971>1080p</button><!--]-->`);
        }
        _push(`</div>`);
        if (mode.value === "v3-0-motion-control") {
          _push(`<p class="form-hint" data-v-8b9b0971>std: standard 720p, pro: professional 1080p.</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
        if (mode.value === "v3-0-motion-control") {
          _push(`<div class="form-group" data-v-8b9b0971><label class="form-label" data-v-8b9b0971>Background source</label><div class="tab-group" data-v-8b9b0971><button type="button" class="${ssrRenderClass([{ active: formData.background_source === "input_video" }, "tab-option"])}" data-v-8b9b0971>video</button><button type="button" class="${ssrRenderClass([{ active: formData.background_source === "input_image" }, "tab-option"])}" data-v-8b9b0971>image</button></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<!--]-->`);
      ...
      if (modeAvatar.value) {
        _push(`<!--[--><div class="form-group" data-v-8b9b0971><label class="form-label" data-v-8b9b0971>Avatar image <span class="required" data-v-8b9b0971>*</span></label>`);
        _push(ssrRenderComponent(UploadImage, {
        ...
        _push(`</div><div class="form-group" data-v-8b9b0971><label class="form-label" data-v-8b9b0971>Audio URL <span class="required" data-v-8b9b0971>*</span></label><input type="file" accept="audio/mpeg,audio/wav,audio/x-wav,audio/aac,audio/mp4,audio/ogg" class="file-input-hidden" data-v-8b9b0971><div class="upload-area" data-v-8b9b0971>`);
        if (isUploadingAvatarAudio.value) {
          _push(`<span data-v-8b9b0971>Uploading...</span>`);
        } else if (formData.audio_url) {
          _push(`<span data-v-8b9b0971>Audio uploaded</span>`);
        } else {
          _push(`<span data-v-8b9b0971>Click to upload audio (MP3/WAV/AAC/OGG, max 10MB)</span>`);
        }
        _push(`</div></div><!--]-->`);
      } else {
        _push(`<!---->`);
      ...
      if (mode.value === "v3-0-video") {
        _push(`<div data-v-8b9b0971><div class="form-group" data-v-8b9b0971><label class="form-label" data-v-8b9b0971>Generation mode</label><div class="tab-group" data-v-8b9b0971><button type="button" class="${ssrRenderClass([klingModeStdClass(), "tab-option"])}" data-v-8b9b0971>std</button><button type="button" class="${ssrRenderClass([klingModeProClass(), "tab-option"])}" data-v-8b9b0971>pro</button></div></div><div class="form-group" data-v-8b9b0971><label class="form-label" data-v-8b9b0971>Multi-shot</label><div class="tab-group" data-v-8b9b0971><button type="button" class="${ssrRenderClass([v3MultiShotsOffClass.value, "tab-option"])}" data-v-8b9b0971>Single shot</button><button type="button" class="${ssrRenderClass([v3MultiShotsOnClass.value, "tab-option"])}" data-v-8b9b0971>Multi-shot</button></div><p class="form-hint" data-v-8b9b0971>Single: one prompt, 3-15s. Multi-shot: up to 5 shots, each 1-12s, total 3-15s; sound must be On.</p></div><div class="form-group" data-v-8b9b0971><label class="form-label" data-v-8b9b0971>Start frame image (optional)</label>`);
        _push(ssrRenderComponent(UploadImage, {
        ...
        _push(`</div>`);
        if (!formData.v3_multi_shots) {
          _push(`<div class="form-group" data-v-8b9b0971><label class="form-label" data-v-8b9b0971>End frame image (optional, single shot)</label>`);
          _push(ssrRenderComponent(UploadImage, {
        ...
        _push(`<div class="form-group" data-v-8b9b0971><label class="form-label" data-v-8b9b0971>Shots + Element</label><p class="form-hint" data-v-8b9b0971>Add groups. Each: prompt + duration + optional element. Total duration 3-15s.</p><div class="shots-list" data-v-8b9b0971><!--[-->`);
        ssrRenderList(formData.v3_multi_prompt, (shot, idx) => {
          _push(`<div class="shot-card" data-v-8b9b0971><div class="shot-title" data-v-8b9b0971>Shot ${ssrInterpolate(idx + 1)}</div><textarea class="shot-text" rows="3"${ssrRenderAttr("placeholder", "Describe this shot...")} maxlength="500" data-v-8b9b0971>${ssrInterpolate(shot.prompt)}</textarea><div class="shot-footer" data-v-8b9b0971><div class="duration-input" data-v-8b9b0971><select class="duration-field duration-select" data-v-8b9b0971><!--[-->`);
          ssrRenderList(v3DurationOptions.value, (d) => {
            _push(`<option${ssrRenderAttr("value", d)} data-v-8b9b0971${ssrIncludeBooleanAttr(Array.isArray(shot.duration) ? ssrLooseContain(shot.duration, d) : ssrLooseEqual(shot.duration, d)) ? " selected" : ""}>${ssrInterpolate(d)}</option>`);
          });
          _push(`<!--]--></select><span class="duration-s" data-v-8b9b0971>s</span></div>`);
          if (formData.v3_multi_shots && formData.v3_multi_prompt.length > 1) {
            _push(`<button type="button" class="shot-delete" title="Delete shot" data-v-8b9b0971><i class="fas fa-trash" data-v-8b9b0971></i></button>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
          if (shot.element) {
            _push(`<div class="v3-shot-element" data-v-8b9b0971><div class="shot-element-label" data-v-8b9b0971>Element for this shot</div><input${ssrRenderAttr("value", shot.element.name)} type="text" class="form-input" placeholder="Element name (e.g. element_dog)" data-v-8b9b0971><textarea class="shot-text shot-text-desc" rows="2" placeholder="Description (required)" data-v-8b9b0971>${ssrInterpolate(shot.element.description)}</textarea>`);
            _push(ssrRenderComponent(UploadImage, {
              ref_for: true,
            ...
            _push(`<button type="button" class="btn-secondary" data-v-8b9b0971>Remove element</button></div>`);
          } else {
            _push(`<button type="button" class="btn-secondary add-element-btn" data-v-8b9b0971>+ Add element for this shot</button>`);
          }
          _push(`</div>`);
        });
        _push(`<!--]--></div>`);
        if (formData.v3_multi_shots && formData.v3_multi_prompt.length < 5) {
          _push(`<button type="button" class="add-shot" data-v-8b9b0971><i class="fas fa-plus" data-v-8b9b0971></i> Add shot </button>`);
        } else {
          _push(`<!---->`);
        }
        if (formData.v3_multi_shots) {
          _push(`<p class="form-hint" data-v-8b9b0971>Total: ${ssrInterpolate(v3MultiShotTotalDuration.value)}s (must be 3-15s).</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
        if (!formData.v3_multi_shots) {
          _push(`<div data-v-8b9b0971><div class="form-group" data-v-8b9b0971><label class="form-label" data-v-8b9b0971>Aspect ratio</label><div class="tab-group" data-v-8b9b0971><button type="button" class="${ssrRenderClass([v3AspectRatio1_1Class.value, "tab-option"])}" data-v-8b9b0971>1:1</button><button type="button" class="${ssrRenderClass([v3AspectRatio16_9Class.value, "tab-option"])}" data-v-8b9b0971>16:9</button><button type="button" class="${ssrRenderClass([v3AspectRatio9_16Class.value, "tab-option"])}" data-v-8b9b0971>9:16</button></div></div><div class="form-group" data-v-8b9b0971><label class="form-label" data-v-8b9b0971>Sound</label><div class="tab-group" data-v-8b9b0971><button type="button" class="${ssrRenderClass([v3SoundOffClass.value, "tab-option"])}" data-v-8b9b0971>Off</button><button type="button" class="${ssrRenderClass([v3SoundOnClass.value, "tab-option"])}" data-v-8b9b0971>On</button></div></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      _push(`<div class="form-actions" data-v-8b9b0971>`);
      if (mode.value === "v2-6-motion-control" || mode.value === "v3-0-motion-control") {
        _push(`<div class="form-hint motion-price-hint" data-v-8b9b0971>`);
        if (mode.value === "v2-6-motion-control") {
          _push(`<span data-v-8b9b0971>720p: 9 credits per second, 1080p: 15 credits per second (billed by uploaded video duration)</span>`);
        } else {
          _push(`<span data-v-8b9b0971>std: 30 credits per second, pro: 40 credits per second (billed by uploaded video duration)</span>`);
        }
        _push(`</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<button type="submit" class="btn-primary"${ssrIncludeBooleanAttr(!canGenerate.value || isGenerating.value || isDetailView.value) ? " disabled" : ""} data-v-8b9b0971>`);
      if (isGenerating.value) {
        _push(`<i class="fas fa-spinner fa-spin" data-v-8b9b0971></i>`);
      } else {
        _push(`<i class="fas fa-play" data-v-8b9b0971></i>`);
      }
      if (isGenerating.value) {
        _push(`<span data-v-8b9b0971>Generating...</span>`);
      } else {
        _push(`<span data-v-8b9b0971> Generate Video `);
        if (klingPriceText.value) {
          _push(`<span class="price-tag" data-v-8b9b0971>${ssrInterpolate(klingPriceText.value)}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</span>`);
      }
      _push(`</button></div></fieldset></form></div><div class="result-panel" data-v-8b9b0971>`);
      if (isDetailView.value && detailData.value && detailData.value.status === 3) {
        _push(`<div class="detail-failure-state" data-v-8b9b0971><div class="failure-icon" data-v-8b9b0971><i class="fas fa-exclamation-circle" data-v-8b9b0971></i></div><p class="failure-message" data-v-8b9b0971>Generation failed. You can try again with different parameters.</p></div>`);
      } else if (isDetailView.value && (!detailData.value || detailData.value.status === 1)) {
        _push(`<div class="detail-loading-state" data-v-8b9b0971><i class="fas fa-spinner fa-spin detail-spinner" data-v-8b9b0971></i><p data-v-8b9b0971>Generating...</p></div>`);
      } else if (displayVideoUrl.value) {
        _push(`<div class="video-result" data-v-8b9b0971><div class="video-player" data-v-8b9b0971><video${ssrRenderAttr("src", displayVideoUrl.value)} controls class="video-element" data-v-8b9b0971></video></div><div class="video-actions" data-v-8b9b0971><button class="action-btn" data-v-8b9b0971><i class="fas fa-download" data-v-8b9b0971></i> Download</button></div></div>`);
      } else {
        _push(`<div class="empty-state" data-v-8b9b0971><h4 data-v-8b9b0971>No video generated yet</h4><p data-v-8b9b0971>Fill in the form and click &quot;Generate Video&quot; to start.</p></div>`);
      }
      _push(`</div></div></div>`);
    };
  }
...
const KlingTool = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8b9b0971"]]);

export { KlingTool as K };
//# sourceMappingURL=KlingTool-Bi6AR_LK.mjs.map
