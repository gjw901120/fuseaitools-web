...
import { S as SeedreamTool } from './SeedreamTool-CElOSdMo.mjs';
...
const _sfc_main = {
  __name: "5-lite-image-to-image",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      name: "Seedream 5 Lite Image to Image Generator",
      description: "Edit images with text using Seedream 5 Lite. Pay per image with credits.",
      category: "image",
      route: "/home/seedream/5-lite-image-to-image",
      keywords: ["Seedream", "Image to Image", "AI image", "5 Lite"],
      applicationCategory: "MultimediaApplication",
      applicationSubCategory: "Image Generation",
      offers: { price: "0", priceCurrency: "USD" },
      offerDescription: "Pay per image with credits.",
      priceFromApi: { modelKey: "seedream-5-lite-image-to-image", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-6225a92f${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/seedream/5-lite-image-to-image.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _5LiteImageToImage = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6225a92f"]]);

export { _5LiteImageToImage as default };
//# sourceMappingURL=5-lite-image-to-image-q5SYr0d1.mjs.map
