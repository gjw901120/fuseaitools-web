...
import { K as KlingTool } from './KlingTool-BmvFVL1I.mjs';
...
const _sfc_main = {
  __name: "v3-0-motion-control",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      name: "Kling 3.0 Motion Control",
      description: "Generate motion-controlled videos from one image and one video using Kling 3.0. Support std/pro quality and background source control.",
      category: "video",
      route: "/home/kling/v3-0-motion-control",
      keywords: ["Kling", "Kuaishou", "3.0 Motion Control", "AI video", "Motion Control"],
      applicationCategory: "MultimediaApplication",
      applicationSubCategory: "Video Generation",
      offers: { price: "0", priceCurrency: "USD" },
      offerDescription: "Pay per video with credits.",
      priceFromApi: { modelKey: "kling-3.0-motion-control", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-d474e98b${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/kling/v3-0-motion-control.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const v30MotionControl = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d474e98b"]]);

export { v30MotionControl as default };
//# sourceMappingURL=v3-0-motion-control-KwFizORM.mjs.map
