  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(chatMessages.value, (message) => {
        ...
        _push(`</div><div class="message-content" data-v-f923aa6d><div class="message-text" data-v-f923aa6d>${(_a = formatMessageText(message.text)) != null ? _a : ""}</div>`);
...
//# sourceMappingURL=ChatInterface-Cos3zynh.mjs.map
