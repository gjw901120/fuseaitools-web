import { g as getToolBreadcrumbByRoute } from './HomeLayout-DmP_sp7g.mjs';
import { g as getPriceRangeFromData } from './useModelPrice-DCrt0_k3.mjs';
  ...
  if (effectivePriceSpec && effectivePriceSpec.price != null) {
    offerSchema.priceSpecification = {
      ...
      "eligibleQuantity": {
        ...
        "name": (_a = effectivePriceSpec.eligibleQuantityName) != null ? _a : "Credits Required",
        "minValue": (_b = effectivePriceSpec.minValue) != null ? _b : effectivePriceSpec.price,
        "maxValue": (_c = effectivePriceSpec.maxValue) != null ? _c : effectivePriceSpec.price,
        "unitCode": "C62"
      }
    };
  }
...
async function useToolSEOAsync(toolInfo) {
  ...
  const autoSpec = range.minCredits != null && range.maxCredits != null ? {
    ...
    eligibleQuantityName: (_a = priceFromApi.eligibleQuantityName) != null ? _a : "Credits Required",
...
export { useToolSEOAsync as a, useToolSEO as u };
//# sourceMappingURL=useToolSEO-Da7aGo7f.mjs.map
