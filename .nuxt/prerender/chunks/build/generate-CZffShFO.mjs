...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      ...
      description: "Generate and edit images with Nano Banana (Gemini Flash Image). Pay per image with credits.",
      category: "image",
      ...
      priceFromApi: { modelKey: "nano-banana", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-deb4240f${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/nano-banana/generate.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const generate = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-deb4240f"]]);

export { generate as default };
//# sourceMappingURL=generate-CZffShFO.mjs.map
