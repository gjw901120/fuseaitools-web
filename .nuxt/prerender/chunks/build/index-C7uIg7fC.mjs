...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "hero-section" }, _attrs))} data-v-02a55e62><div class="simply-container" data-v-02a55e62><div class="hero-content" data-v-02a55e62><div class="hero-text" data-v-02a55e62><h1 class="hero-title" data-v-02a55e62> All-in-One AI Platform <span class="gradient-text" data-v-02a55e62>50+ AI Models &amp; Tools Free</span></h1><p class="hero-description" data-v-02a55e62> Access over 50 AI models and tools in one platform\u2014Chat, Image, Audio, and Video. Everything you need to work smarter. </p><p class="hero-credits" data-v-02a55e62><strong data-v-02a55e62>Register now and get <span class="credits-highlight" data-v-02a55e62>100 credits free</span>.</strong> No credit card required. </p><div class="hero-actions" data-v-02a55e62><button class="btn-primary" data-v-02a55e62> Get 100 Free Credits </button><button class="btn-secondary" data-v-02a55e62> Explore AI Tools Free </button></div><div class="hero-features" data-v-02a55e62><div class="feature-pill feature-pill-free" data-v-02a55e62><i class="fas fa-gift" data-v-02a55e62></i> AI Tools Free </div><div class="feature-pill" data-v-02a55e62><i class="fas fa-brain" data-v-02a55e62></i> 50+ AI Models </div></div></div><div class="hero-visual" data-v-02a55e62><div class="ai-demo-window" data-v-02a55e62><div class="window-header" data-v-02a55e62><div class="window-controls" data-v-02a55e62><span class="control red" data-v-02a55e62></span><span class="control yellow" data-v-02a55e62></span><span class="control green" data-v-02a55e62></span></div><div class="window-title" data-v-02a55e62>FuseAI Chat</div></div><div class="chat-messages" data-v-02a55e62><div class="message user-message" data-v-02a55e62><div class="avatar" data-v-02a55e62>\u{1F464}</div><div class="content" data-v-02a55e62>Can you help me write a Python function to calculate factorial?</div></div><div class="message ai-message" data-v-02a55e62><div class="avatar" data-v-02a55e62>\u{1F916}</div><div class="content" data-v-02a55e62><pre data-v-02a55e62><code data-v-02a55e62>def factorial(n):
    if n == 0:
        return 1
    else:
        return n * factorial(n-1)</code></pre></div></div><div class="message user-message" data-v-02a55e62><div class="avatar" data-v-02a55e62>\u{1F464}</div><div class="content" data-v-02a55e62>Great! Can you add error handling?</div></div></div><div class="chat-input" data-v-02a55e62><input type="text" placeholder="Ask me anything..."${ssrRenderAttr("value", unref(userInput))} data-v-02a55e62><button class="send-btn" data-v-02a55e62><i class="fas fa-paper-plane" data-v-02a55e62></i></button></div></div></div></div></div></section>`);
    };
  }
};
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-02a55e62"]]);
const _sfc_main$2 = {
  __name: "ImageGallery",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    const videoModels = ref([
      ...
      },
      {
        ...
        route: "/home/hailuo/image-to-video-pro"
      },
      {
        title: "Kling",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "image-gallery" }, _attrs))} data-v-6995c7ce><div class="simply-container" data-v-6995c7ce><div class="gallery-header" data-v-6995c7ce><h2 class="gallery-title" data-v-6995c7ce>Product Showcase</h2><p class="gallery-description" data-v-6995c7ce>Explore our AI tools and features</p></div><div class="gallery-categories" data-v-6995c7ce><div class="categories-list" data-v-6995c7ce><div class="category-row-item" data-v-6995c7ce><div class="category-label chat-label" data-v-6995c7ce>Chat</div><div class="category-items" data-v-6995c7ce><!--[-->`);
      ssrRenderList(unref(chatModels), (item) => {
        _push(`<article data-v-6995c7ce>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="logo-card" data-v-6995c7ce${_scopeId}><div class="logo-wrapper" data-v-6995c7ce${_scopeId}><img${ssrRenderAttr("src", item.logo)}${ssrRenderAttr("alt", item.title)} class="model-logo" data-v-6995c7ce${_scopeId}></div><h3 class="model-title" data-v-6995c7ce${_scopeId}>${ssrInterpolate(item.title)}</h3></div>`);
            } else {
              return [
      ...
      _push(`<!--]--></div></div><div class="category-row-item" data-v-6995c7ce><div class="category-label image-label" data-v-6995c7ce>Image</div><div class="category-items" data-v-6995c7ce><!--[-->`);
      ...
      _push(`<!--]--></div></div><div class="category-row-item" data-v-6995c7ce><div class="category-label audio-label" data-v-6995c7ce>Audio</div><div class="category-items" data-v-6995c7ce><!--[-->`);
      ...
      _push(`<!--]--></div></div><div class="category-row-item" data-v-6995c7ce><div class="category-label video-label" data-v-6995c7ce>Video</div><div class="category-items" data-v-6995c7ce><!--[-->`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-6995c7ce"]]);
const _sfc_main$1 = {
  __name: "FAQSection",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "faq-section" }, _attrs))} data-v-b21f831d><div class="simply-container" data-v-b21f831d><div class="faq-header" data-v-b21f831d><h2 class="faq-title" data-v-b21f831d>Frequently Asked Questions</h2></div><div class="faq-list" data-v-b21f831d><!--[-->`);
      ssrRenderList(faqItems.value, (item, index2) => {
        var _a;
        _push(`<article class="${ssrRenderClass([{ "active": item.isOpen }, "faq-item"])}" data-v-b21f831d><div class="faq-question" data-v-b21f831d><h3 class="question-text" data-v-b21f831d>${ssrInterpolate(item.question)}</h3><div class="faq-icon" data-v-b21f831d><i class="${ssrRenderClass([item.isOpen ? "fa-chevron-up" : "fa-chevron-down", "fas"])}" data-v-b21f831d></i></div></div>`);
        if (item.isOpen) {
          _push(`<div class="faq-answer" data-v-b21f831d><div class="faq-content" data-v-b21f831d>${(_a = item.answer) != null ? _a : ""}</div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</article>`);
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-b21f831d"]]);
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "homepage" }, _attrs))} data-v-1f1ee6e6>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1f1ee6e6"]]);

export { index as default };
//# sourceMappingURL=index-C7uIg7fC.mjs.map
