...
import { getContext, executeAsync } from 'file://C:/project/fuseaitools-web/node_modules/unctx/dist/index.mjs';
import { getRequestHeaders, createError as createError$1, sanitizeStatusCode, appendHeader } from 'file://C:/project/fuseaitools-web/node_modules/h3/dist/index.mjs';
import { RouterView, useRoute as useRoute$1, createMemoryHistory, createRouter, START_LOCATION } from 'file://C:/project/fuseaitools-web/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file://C:/project/fuseaitools-web/node_modules/radix3/dist/index.mjs';
import { defu } from 'file://C:/project/fuseaitools-web/node_modules/defu/dist/defu.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file://C:/project/fuseaitools-web/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file://C:/project/fuseaitools-web/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-BiNQByJd.mjs')
  },
  {
    name: "index",
    path: "/",
  ...
  },
  {
    ...
    component: () => import('./credits-CYBWqmGY.mjs')
  },
  {
    name: "pricing",
    path: "/pricing",
    component: () => import('./pricing-laxUEnIh.mjs')
  },
  {
    name: "home-gpt",
    path: "/home/gpt",
    component: () => import('./gpt-BiFn62qG.mjs'),
    children: [
      {
        name: "home-gpt-generate",
        path: "generate",
        component: () => import('./generate-D4frWCvJ.mjs')
      }
    ]
  },
  {
    name: "home-wan",
    path: "/home/wan",
    component: () => import('./wan-At7zvfWW.mjs'),
    children: [
      {
  ...
  },
  {
    name: "home-luma",
    path: "/home/luma",
    component: () => import('./luma-CD_17mt3.mjs'),
    children: [
      {
        name: "home-luma-generate",
        path: "generate",
        component: () => import('./generate-HcIJJNHl.mjs')
      }
    ]
  },
  {
    name: "home-qwen",
    path: "/home/qwen",
    component: () => import('./qwen-CxrX0pvo.mjs'),
    children: [
      {
  ...
  },
  {
    name: "home-sora",
    path: "/home/sora",
    component: () => import('./sora-BA5yql8R.mjs'),
    children: [
      {
        name: "home-sora-text-to-video",
        path: "text-to-video",
        component: () => import('./text-to-video-zJMNa8Xy.mjs')
      },
      {
        name: "home-sora-image-to-video",
        path: "image-to-video",
        component: () => import('./image-to-video-DLAkv7PL.mjs')
      },
      {
        name: "home-sora-pro-storyboard",
        path: "pro-storyboard",
        component: () => import('./pro-storyboard-DduIdAOz.mjs')
      },
      {
        name: "home-sora-pro-text-to-video",
        path: "pro-text-to-video",
        component: () => import('./pro-text-to-video-DSQFjq9l.mjs')
      },
      {
        name: "home-sora-watermark-remover",
        path: "watermark-remover",
        component: () => import('./watermark-remover-C46NhV5d.mjs')
      },
      {
        name: "home-sora-pro-image-to-video",
        path: "pro-image-to-video",
        component: () => import('./pro-image-to-video-DD8Zkm49.mjs')
      }
    ]
  },
  {
    name: "home-suno",
    path: "/home/suno",
    component: () => import('./suno-DwbC6jsL.mjs'),
    children: [
      {
        name: "home-suno-extend",
        path: "extend",
        component: () => import('./extend-ZhRt1Jy0.mjs')
      },
      {
        name: "home-suno-generate",
        path: "generate",
        component: () => import('./generate-D93D0dkn.mjs')
      },
      {
        name: "home-suno-add-vocals",
        path: "add-vocals",
        component: () => import('./add-vocals-CiG3_TZ0.mjs')
      },
      {
        name: "home-suno-upload-cover",
        path: "upload-cover",
        component: () => import('./upload-cover-KBSHBd-u.mjs')
      },
      {
        name: "home-suno-upload-extend",
        path: "upload-extend",
        component: () => import('./upload-extend-DePkRr52.mjs')
      },
      {
        name: "home-suno-add-instrumental",
        path: "add-instrumental",
        component: () => import('./add-instrumental-C_nvCRAE.mjs')
      }
    ]
  },
  {
    name: "home-veo3",
    path: "/home/veo3",
    component: () => import('./veo3-DRNdMn69.mjs'),
    children: [
      {
        name: "home-veo3-extend",
        path: "extend",
        component: () => import('./extend-BTX32jK_.mjs')
      },
      {
        name: "home-veo3-text-to-video",
        path: "text-to-video",
        component: () => import('./text-to-video-v6DsKnEd.mjs')
      },
      {
        name: "home-veo3-reference-to-video",
        path: "reference-to-video",
        component: () => import('./reference-to-video-DGs2Yb9K.mjs')
      },
      {
        name: "home-veo3-first-and-last-to-video",
        path: "first-and-last-to-video",
        component: () => import('./first-and-last-to-video-DeruSFLk.mjs')
      }
    ]
  },
  {
  ...
  },
  {
    name: "home-kling",
    path: "/home/kling",
    component: () => import('./kling-n9RF55_J.mjs'),
    children: [
      {
  ...
  },
  {
    name: "news",
    path: "/news",
    component: () => import('./index-CDLj0LmW.mjs')
  },
  {
    name: "home-claude",
    path: "/home/claude",
    component: () => import('./claude-D7UV3zRO.mjs'),
    children: [
      {
        name: "home-claude-generate",
        path: "generate",
        component: () => import('./generate-BFMA8JNe.mjs')
      }
    ]
  },
  {
    name: "home-gemini",
    path: "/home/gemini",
    component: () => import('./gemini-B4o60I-B.mjs'),
    children: [
      {
        name: "home-gemini-generate",
        path: "generate",
        component: () => import('./generate-Cot8ypN5.mjs')
      }
    ]
  },
  {
    name: "home-hailuo",
    path: "/home/hailuo",
    component: () => import('./hailuo-CMX3FY-7.mjs'),
    children: [
      {
  ...
  },
  {
    name: "home-runway",
    path: "/home/runway",
    component: () => import('./runway-DxfiwZWi.mjs'),
    children: [
      {
        name: "home-runway-aleph",
        path: "aleph",
        component: () => import('./aleph-CO8uSYc5.mjs')
      },
      {
        name: "home-runway-extend",
        path: "extend",
        component: () => import('./extend-Cg_OP6qR.mjs')
      },
      {
        name: "home-runway-generate",
        path: "generate",
        component: () => import('./generate-Cd3bQrUE.mjs')
      }
    ]
  },
  {
    ...
    component: () => import('./_slug_-XZDD2WIy.mjs')
  },
  {
    name: "test-routes",
    path: "/test-routes",
    component: () => import('./test-routes-DKqpUqa1.mjs')
  },
  {
    name: "home-imagen4",
    path: "/home/imagen4",
    component: () => import('./imagen4-Dn10rZw-.mjs'),
    children: [
      {
  ...
  },
  {
    name: "home-deepseek",
    path: "/home/deepseek",
    component: () => import('./deepseek-C_AkXUc9.mjs'),
    children: [
      {
        name: "home-deepseek-generate",
        path: "generate",
        component: () => import('./generate-BHY2pxar.mjs')
      }
    ]
  },
  {
    name: "home-ideogram",
    path: "/home/ideogram",
    component: () => import('./ideogram-BWnCo4pn.mjs'),
    children: [
      {
      ...
      },
      {
        ...
        path: "generate",
        component: () => import('./generate-DHYjYhGa.mjs')
      },
      {
  ...
  },
  {
    name: "home-seedance",
    path: "/home/seedance",
    component: () => import('./seedance-DRk3Q6As.mjs'),
    children: [
      {
  ...
  },
  {
    name: "home-seedream",
    path: "/home/seedream",
    component: () => import('./seedream-iqr1JSkJ.mjs'),
    children: [
      {
  ...
  },
  {
    name: "home-gpt-image",
    path: "/home/gpt-image",
    component: () => import('./gpt-image-LJEcFB5B.mjs'),
    children: [
      {
        name: "home-gpt-image-generate",
        path: "generate",
        component: () => import('./generate-DvmVsBZr.mjs')
      },
      {
  ...
  },
  {
    ...
    component: () => import('./elevenlabs-CeTLQH4E.mjs'),
    children: [
      {
        name: "home-elevenlabs-turbo-2-5",
        path: "turbo-2-5",
        component: () => import('./turbo-2-5-B_uCAbL1.mjs')
      },
      {
        name: "home-elevenlabs-speech-to-text",
        path: "speech-to-text",
        component: () => import('./speech-to-text-ByyP6DR1.mjs')
      },
      {
        name: "home-elevenlabs-audio-isolation",
        path: "audio-isolation",
        component: () => import('./audio-isolation-BSATa40e.mjs')
      },
      {
        name: "home-elevenlabs-multilingual-v2",
        path: "multilingual-v2",
        component: () => import('./multilingual-v2-CXwiioSK.mjs')
      },
      {
        name: "home-elevenlabs-sound-effect-v2",
        path: "sound-effect-v2",
        component: () => import('./sound-effect-v2-BDt0IWsd.mjs')
      }
    ]
  },
  {
    ...
    component: () => import('./midjourney-CTsH8OSn.mjs'),
    children: [
      {
        name: "home-midjourney-vary",
        path: "vary",
        component: () => import('./vary-CB9LESOz.mjs')
      },
      {
        name: "home-midjourney-imagine",
        path: "imagine",
        component: () => import('./imagine-CgchNNba.mjs')
      },
      {
        name: "home-midjourney-upscale",
        path: "upscale",
        component: () => import('./upscale-CKEb9ddw.mjs')
      }
    ]
  },
  {
    ...
    component: () => import('./nano-banana-B5aLCawW.mjs'),
    children: [
      {
        name: "home-nano-banana-edit",
        path: "edit",
        component: () => import('./edit-BVulETLC.mjs')
      },
      {
        name: "home-nano-banana-generate",
        path: "generate",
        component: () => import('./generate-CZffShFO.mjs')
      },
      {
        name: "home-nano-banana-pro-generate",
        path: "pro-generate",
        component: () => import('./pro-generate-CVA-LuwO.mjs')
      },
      {
        name: "home-nano-banana-nano-banana-2",
        path: "nano-banana-2",
        component: () => import('./nano-banana-2-hk7fMUJN.mjs')
      }
    ]
  },
  {
  ...
  },
  {
    ...
    component: () => import('./gpt-4o-image-DOP3ikPl.mjs'),
    children: [
      {
        name: "home-gpt-4o-image-generate",
        path: "generate",
        component: () => import('./generate-Dyl1sWkS.mjs')
      }
    ]
  },
  {
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CtfT8DyB.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-8pB3_I3a.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CfzCxVOo.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, useRoute as d, entry$1 as default, __nuxt_component_1 as e, useRequestHeaders as f, asyncDataDefaults as g, createError as h, fetchDefaults as i, useRequestFetch as j, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRouter as u };
