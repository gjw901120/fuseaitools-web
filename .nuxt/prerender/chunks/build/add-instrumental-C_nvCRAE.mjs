...
const _sfc_main = {
  __name: "add-instrumental",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      name: "Suno Accompaniment",
      description: "Generate accompaniment with Suno AI. Pay per generation with credits.",
      category: "audio",
      route: "/home/suno/add-instrumental",
      keywords: ["Suno", "Accompaniment", "AI music"],
      ...
      priceFromApi: { modelKey: "suno_add_instrumental", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-44d39064${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/suno/add-instrumental.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const addInstrumental = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-44d39064"]]);

export { addInstrumental as default };
//# sourceMappingURL=add-instrumental-C_nvCRAE.mjs.map
