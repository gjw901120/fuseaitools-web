...
import { W as WanTool } from './WanTool-Dl7b55B3.mjs';
...
const _sfc_main = {
  __name: "video-to-video",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      name: "Wan Video to Video Generator",
      description: "Transform video with new prompts using Wan. Pay per video with credits.",
      category: "video",
      route: "/home/wan/video-to-video",
      keywords: ["Wan", "Video to Video", "AI video", "video transform"],
      applicationCategory: "MultimediaApplication",
      applicationSubCategory: "Video Generation",
      offers: { price: "0", priceCurrency: "USD" },
      offerDescription: "Pay per video with credits.",
      priceFromApi: { modelKey: "wan-2-6-video-to-video", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-4d4ad0ad${_scopeId}>`);
            _push2(ssrRenderComponent(WanTool, null, null, _parent2, _scopeId));
            _push2(`</div>`);
          } else {
            return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/wan/video-to-video.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const videoToVideo = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4d4ad0ad"]]);

export { videoToVideo as default };
//# sourceMappingURL=video-to-video-H7UjrXSL.mjs.map
