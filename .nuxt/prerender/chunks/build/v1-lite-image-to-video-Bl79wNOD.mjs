...
import { S as SeedanceTool } from './SeedanceTool-pOSlYk0M.mjs';
...
const _sfc_main = {
  __name: "v1-lite-image-to-video",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      name: "Seedance v1 Lite Image to Video Generator",
      description: "Animate images with text using Seedance v1 Lite. Pay per video with credits.",
      category: "video",
      route: "/home/seedance/v1-lite-image-to-video",
      keywords: ["Seedance", "Image to Video", "AI video", "v1-lite"],
      applicationCategory: "MultimediaApplication",
      applicationSubCategory: "Video Generation",
      offers: { price: "0", priceCurrency: "USD" },
      offerDescription: "Pay per video with credits.",
      priceFromApi: { modelKey: "seedance-v1-lite-image-to-video", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-aae4e445${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/seedance/v1-lite-image-to-video.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const v1LiteImageToVideo = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-aae4e445"]]);

export { v1LiteImageToVideo as default };
//# sourceMappingURL=v1-lite-image-to-video-Bl79wNOD.mjs.map
