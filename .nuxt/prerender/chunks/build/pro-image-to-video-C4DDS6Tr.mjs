...
const _sfc_main = {
  ...
  setup(__props) {
    const seoConfig = useToolSEO({
      name: "Sora - Pro Image to Video",
      description: "Use Sora 2 Pro for free online. High-quality image-to-video with size and duration control.",
      category: "video",
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-2401b981${_scopeId}>`);
            _push2(ssrRenderComponent(_component_ClientOnly, null, {
              fallback: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div style="${ssrRenderStyle({ "padding": "20px", "text-align": "center" })}" data-v-2401b981${_scopeId2}>Loading Sora Tool...</div>`);
                } else {
                  return [
...
const proImageToVideo = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2401b981"]]);

export { proImageToVideo as default };
//# sourceMappingURL=pro-image-to-video-C4DDS6Tr.mjs.map
