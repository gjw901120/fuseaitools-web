    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-9b559b4d${_scopeId}>`);
...
const generate = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9b559b4d"]]);

export { generate as default };
//# sourceMappingURL=generate-Cd3bQrUE.mjs.map
