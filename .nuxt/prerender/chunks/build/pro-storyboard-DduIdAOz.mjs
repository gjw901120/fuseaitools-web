    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-bc61e5d6${_scopeId}>`);
            _push2(ssrRenderComponent(_component_ClientOnly, null, {
              fallback: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div style="${ssrRenderStyle({ "padding": "20px", "text-align": "center" })}" data-v-bc61e5d6${_scopeId2}>Loading Sora Tool...</div>`);
                } else {
                  return [
...
const proStoryboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-bc61e5d6"]]);

export { proStoryboard as default };
//# sourceMappingURL=pro-storyboard-DduIdAOz.mjs.map
