    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-c12b01b0${_scopeId}>`);
...
const v25TurboTextToVideoPro = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c12b01b0"]]);

export { v25TurboTextToVideoPro as default };
//# sourceMappingURL=v2-5-turbo-text-to-video-pro-Cc3dm7en.mjs.map
