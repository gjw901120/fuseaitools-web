...
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderClass, ssrInterpolate, ssrIncludeBooleanAttr, ssrRenderComponent, ssrRenderList, ssrLooseContain } from 'file://C:/project/fuseaitools-web/node_modules/vue/server-renderer/index.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (mode.value === "video-to-video") {
        ...
        if (isUploadingVideo.value) {
          ...
          _push(`<div class="wan-video-preview-wrap" data-v-f0e1cd1c><video${ssrRenderAttr("src", formData.videoUrls[0])} class="wan-video-preview" controls data-v-f0e1cd1c></video><button type="button" class="wan-video-remove" title="Remove" data-v-f0e1cd1c>\xD7</button></div>`);
        } else {
...
export { WanTool as W };
//# sourceMappingURL=WanTool-Dl7b55B3.mjs.map
