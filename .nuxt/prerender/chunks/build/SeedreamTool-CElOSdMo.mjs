...
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderClass, ssrInterpolate, ssrIncludeBooleanAttr, ssrRenderComponent, ssrRenderList } from 'file://C:/project/fuseaitools-web/node_modules/vue/server-renderer/index.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!isDetailView.value && unref(route).path === "/home/seedream/5-lite-text-to-image") {
        _push(`<div class="tutorial-showcase" data-v-f5a8e7a1><p class="tutorial-showcase-title" data-v-f5a8e7a1>\u{1F3A8} Tutorial Showcase</p><div class="tutorial-showcase-links" data-v-f5a8e7a1><a href="https://www.fuseaitools.com/news/seedream-nezha-first-last-frame-tutorial" target="_blank" rel="noopener noreferrer" class="tutorial-link" data-v-f5a8e7a1>First &amp; last frame images for video (Nezha &amp; Ao Bing sprint) \u2014 Seedream 5 Lite</a></div></div>`);
      } else {
        _push(`<!---->`);
      }
...
//# sourceMappingURL=SeedreamTool-CElOSdMo.mjs.map
