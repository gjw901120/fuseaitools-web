    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-705df06c${_scopeId}>`);
...
const referenceToVideo = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-705df06c"]]);

export { referenceToVideo as default };
//# sourceMappingURL=reference-to-video-DGs2Yb9K.mjs.map
