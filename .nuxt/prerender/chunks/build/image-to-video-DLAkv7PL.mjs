...
const _sfc_main = {
  __name: "image-to-video",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      name: "Sora Image to Video Generator",
      description: "Generate videos from reference images using OpenAI Sora 2. Pay per video with credits.",
      category: "video",
      route: "/home/sora/image-to-video",
      keywords: ["Sora", "Sora 2", "image-to-video", "AI video generation", "OpenAI Sora"],
      applicationCategory: "MultimediaApplication",
      applicationSubCategory: "Video Generation",
      offers: { price: "0", priceCurrency: "USD" },
      offerDescription: "Pay per video with credits.",
      priceFromApi: { modelKey: "sora-2-image-to-video", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-8d0a94e1${_scopeId}>`);
            _push2(ssrRenderComponent(_component_ClientOnly, null, {
              fallback: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div style="${ssrRenderStyle({ "padding": "20px", "text-align": "center" })}" data-v-8d0a94e1${_scopeId2}>Loading Sora Tool...</div>`);
                } else {
                  return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/sora/image-to-video.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const imageToVideo = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8d0a94e1"]]);

export { imageToVideo as default };
//# sourceMappingURL=image-to-video-DLAkv7PL.mjs.map
