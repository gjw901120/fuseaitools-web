...
const _sfc_main = {
  __name: "v2-6-image-to-video",
  __ssrInlineRender: true,
  async setup(__props) {
    let __temp, __restore;
    const seoConfig = ([__temp, __restore] = withAsyncContext(() => useToolSEOAsync({
      name: "Kling 2.6 Image to Video Generator",
      description: "Generate image-to-video with Kling 2.6. Pay per video with credits.",
      category: "video",
      route: "/home/kling/v2-6-image-to-video",
      keywords: ["Kling", "Kuaishou", "Image to Video", "AI video", "2.6"],
      applicationCategory: "MultimediaApplication",
      applicationSubCategory: "Video Generation",
      offers: { price: "0", priceCurrency: "USD" },
      offerDescription: "Pay per video with credits.",
      priceFromApi: { modelKey: "kling-2.6-image-to-video", eligibleQuantityName: "Credits Required" }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_HomeLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="tool-page" data-v-de44fe17${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/home/kling/v2-6-image-to-video.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const v26ImageToVideo = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-de44fe17"]]);

export { v26ImageToVideo as default };
//# sourceMappingURL=v2-6-image-to-video-DPxXED3x.mjs.map
