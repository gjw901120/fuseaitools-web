...
- [ ] `workflowDefinitionMap` + 每路由专属 FAQ  
- [ ] 四子页独立 description / keywords（含 HappyHorse v1、FuseAITools）  
- [ ] `useToolSeoFaqSchema`  
- [ ] Technical specs + 四模式能力简表  
- [ ] 聚合页 `toolOverviews['happy-horse']` 精简为 3 段并与子页一致  
...
**文档版本**：1.1  
**最后更新**：2026-05-20  
**维护**：Wan 7 视频 + 聚合页为参考实现；HappyHorse 按 §10 对齐。路由/计费变更时同步 §9.2、`PRICING_MAPPING.md`、`llms.txt`。
